...
2. Fork the repository, clone it, and create a new branch.
	...
	git clone https://github.com/<your-username>/Seall---based-on-seanime.git
	# Navigate to the directory
	cd Seall---based-on-seanime
	# Assign to a remote called "upstream"
	git remote add upstream https://github.com/Kolex06/Seall---based-on-seanime.git
	```
...
[Issues](https://github.com/Kolex06/Seall---based-on-seanime/issues?q=is%3Aissue+is%3Aopen+label%3A%22open+to+contribution%22)
