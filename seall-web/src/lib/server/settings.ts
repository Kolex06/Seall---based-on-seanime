...
export const settingsSchema = z.object({
    ...
    enableManga: z.boolean().optional().default(false),
    ...
    richPresenceHideSeallRepositoryButton: z.boolean().optional().default(false),
    richPresenceShowSIMKLMediaButton: z.boolean().optional().default(false),
    richPresenceShowSIMKLProfileButton: z.boolean().optional().default(false),
...
export const getDefaultSettings = (data: z.infer<typeof gettingStartedSchema>): GettingStarted_Variables => ({
    ...
    discord: {
        ...
        richPresenceHideSeallRepositoryButton: false,
        richPresenceShowSIMKLMediaButton: false,
        richPresenceShowSIMKLProfileButton: false,
