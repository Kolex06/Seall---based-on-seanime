const CLIENT_ID_STORAGE_KEY = "seall-client-id"
const CLIENT_ID_PROOF_STORAGE_KEY = "seall-client-id-proof"
...
function createClientId(): string {
    ...
    if (typeof crypto === "undefined" || typeof crypto.getRandomValues !== "function") {
        return `seall-${Math.random().toString(16).slice(2)}-${Date.now().toString(16)}`
    }
