export const enum WSEvents {
    ...
    MEDIA_DATA_LOADED = "server-ready",
    SERVER_LOGGED_OUT_SIMKL = "server-logged-out-simkl",
    SCAN_PROGRESS = "scan-progress",
    SCAN_STATUS = "scan-status",
    REFRESHED_MEDIA_COLLECTION = "refreshed-media-collection",
    REFRESHED_MANGA_COLLECTION = "refreshed-manga-collection",
    ...
    SYNC_MEDIA_FINISHED = "sync-media-finished",
