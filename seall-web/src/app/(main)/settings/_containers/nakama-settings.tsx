...
export function NakamaSettings(props: Props) {
    ...
    return (
        <div className="space-y-4">
            ...
            <SettingsPageHeader
                title="Nakama"
                description="Communicate with other Seall instances"
            ...
            >
                ...
                <TabsContent value="host" className={tabContentClass}>
                    ...
                    <SettingsCard className="!bg-gray-900 text-sm">
                        <div>
                            <p>
                                Host mode is intended for Seall servers that are accessible over the internet.
                            </p>
                            <p>
                    ...
                    {nakamaIsHost && <SettingsCard title="Settings">
                        ...
                        <Field.Switch
                            ...
                            label="Share local media library"
                            help="If enabled, this server will share its local media library with other clients."
                        />

                        <Field.MediaExclusionSelector
                            name="nakamaHostUnsharedAnimeIds"
                            label="Exclude media from sharing"
                            help="Select media that you don't want to share with other clients."
                        />
                    </SettingsCard>}
                </TabsContent>
                ...
                <TabsContent value="peer" className={tabContentClass}>
                    ...
                    {!serverStatus?.settings?.nakama?.isHost && <SettingsCard title="Settings">
                        <Field.Switch
                            ...
                            label="Use Nakama shared media library"
                            help="If enabled, Nakama's shared media library will be used as your library."
                        />
                    </SettingsCard>}
                </TabsContent>
