...
import { MEDIA_COLLECTION_SORTING_OPTIONS, CONTINUE_WATCHING_SORTING_OPTIONS } from "@/lib/helpers/filtering"
...
export function UISettings() {
    ...
    function handleSave(data: z.infer<typeof themeSchema>) {
        if (colord(data.backgroundColor).isLight()) {
            toast.error("Seall does not support light themes")
            return
        }
                    ...
                    >
                        ...
                        <TabsContent value="main" className={tabContentClass} data-settings-ui-panel-general>
                            ...
                            <SettingsCard title="Sorting">
                                ...
                                <Field.Select
                                    label="Media library sorting"
                                    name="animeLibraryCollectionDefaultSorting"
                                    options={MEDIA_COLLECTION_SORTING_OPTIONS.filter(n => !n.value.includes("END"))
                            ...
                            <SettingsCard title="Tweaks">
                                ...
                                {isSimulatedUser && (
                                    <p className="text-orange-300/50 text-sm">
                                        Navigation preloading is disabled for use without an SIMKL account due to rate limits.
                                    </p>
                                )}
                                ...
                                <Field.Switch
                                    ...
                                    label={swLabel(
                                        ...
                                        "Watchlist card unwatched count",
                                    )}
                        ...
                        {/*            help="Seall will try to fix border rendering artifacts. This setting only affects this client/browser."*/}
