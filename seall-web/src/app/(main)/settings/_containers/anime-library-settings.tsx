                    ...
                    <AccordionContent className="space-y-4">
                        ...
                        {useLegacyMatching && <div className="flex flex-col md:flex-row gap-3">
                            <Field.Select
                                ...
                                help="Choose the algorithm used to match files to SIMKL entries."
                            />
                            <Field.Number
                                name="scannerMatchingThreshold"
                                label="Matching threshold"
                                placeholder="0.5"
                                help="The minimum score required for a file to be matched to an SIMKL entry. Default is 0.5."
                                formatOptions={{
