    ...
    return (
        <>
            <SettingsCard title="Rich Presence" description="Show what you are watching or reading in Discord.">
                ...
                <Field.Switch
                    side="right"
                    name="richPresenceHideSeallRepositoryButton"
                    label="Hide Seall Repository Button"
                />

                {/*<Field.Switch*/}
                {/*    side="right"*/}
                {/*    name="richPresenceShowSIMKLMediaButton"*/}
                {/*    label="Show SIMKL Media Button"*/}
                {/*    help="Show a button to open the media page on SIMKL."*/}
                {/*/>*/}

                <Field.Switch
                    side="right"
                    name="richPresenceShowSIMKLProfileButton"
                    label="Show SIMKL Profile Button"
                    help="Show a button to open your profile page on SIMKL."
                />
                ...
                {/*    help="Replace 'Seall' with the media title in the activity status. Only works if you use a discord client that utilizes arRPC."*/}
                {/*/>*/}
            </SettingsCard>
        </>
    )
