                ...
                >
                    <TabsList className="flex-wrap max-w-full lg:space-y-2 lg:sticky lg:top-10">
                            ...
                            <div className="overflow-x-none overflow-y-hidden rounded-[--radius-md] space-y-1 lg:space-y-3 flex justify-center flex-wrap lg:block">
                                ...
                                <Card className="lg:p-2 contents lg:block border-0 bg-transparent lg:border lg:bg-gray-950/80">
                                    ...
                                    <TabsTrigger
                                        value="library"
                                        className="group"
                                    ><LuLibrary className="text-xl mr-3 transition-transform duration-200" /> Local Media Library</TabsTrigger>
                                </Card>
                        ...
                        <div className="flex justify-center !mt-0 pb-4">
                            <SeaLink
                                href="https://github.com/Kolex06/Seall---based-on-seanime"
                                target="_blank"
                            ...
                            >
                                <Button
                                    intent="gray-link"
                                    size="md"
                                    leftIcon={<FaGithub className="text-lg" />}
                                >
                                    GitHub
                                </Button>
                            </SeaLink>
                    ...
                    <div className="">
                        <Form
                            ...
                            onSubmit={async data => {
                                await saveSettings({
                                    ...
                                    discord: {
                                        ...
                                        richPresenceHideSeallRepositoryButton: data?.richPresenceHideSeallRepositoryButton ?? false,
                                        richPresenceShowSIMKLMediaButton: data?.richPresenceShowSIMKLMediaButton ?? false,
                                        richPresenceShowSIMKLProfileButton: data?.richPresenceShowSIMKLProfileButton ?? false,
                            ...
                            defaultValues={{
                                ...
                                hideAudienceScore: status?.settings?.simkl?.hideAudienceScore ?? false,
                                ...
                                enableAdultContent: status?.settings?.simkl?.enableAdultContent ?? false,
                                blurAdultContent: status?.settings?.simkl?.blurAdultContent ?? false,
                                ...
                                richPresenceHideSeallRepositoryButton: status?.settings?.discord?.richPresenceHideSeallRepositoryButton ?? false,
                                richPresenceShowSIMKLMediaButton: status?.settings?.discord?.richPresenceShowSIMKLMediaButton ?? false,
                                richPresenceShowSIMKLProfileButton: status?.settings?.discord?.richPresenceShowSIMKLProfileButton ?? false,
                        ...
                        >
                            {(f) => {
                                return <>
                                    <SettingsIsDirty />
                                    <TabsContent value="seall" className={tabContentClass}>
                                    ...
                                    <TabsContent value="library" className={tabContentClass}>
                                        ...
                                        <SettingsPageHeader
                                            ...
                                            description="Manage your local media library"
                                            icon={LuLibrary}
                                        />
                                    ...
                                    <TabsContent value="onlinestream" className={tabContentClass}>
                                        ...
                                        <SettingsCard>
                                            <div data-settings-enable-onlinestream>
                                                <Field.Switch
                                                    ...
                                                    label="Enable"
                                                    help="Watch from online sources."
                                                />
                                            </div>
                                        </SettingsCard>
                                        ...
                                        <SettingsCard title="Home Screen">
                                            <Field.Switch
                                                ...
                                                label="Include streaming in watchlist"
                                                help="Show currently watching streaming titles in your watchlist."
                                            />
                                        </SettingsCard>
                                            ...
                                            <AccordionItem value="qbittorrent">
                                                ...
                                                <AccordionContent className="p-0 py-4 space-y-4">
                                                    ...
                                                    <Field.Text
                                                        ...
                                                        label="Tags"
                                                        help="Comma separated tags to apply to downloaded torrents. e.g. seall,media"
                                                    />
                                                    <Field.Text
