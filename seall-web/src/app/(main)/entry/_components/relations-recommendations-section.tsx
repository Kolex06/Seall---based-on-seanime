import { MediaAPI_MediaDetailsById_Media, Media_Entry, Nullish } from "@/api/generated/types"
...
type RelationsRecommendationsSectionProps = {
    entry: Nullish<Media_Entry>
    details: Nullish<MediaAPI_MediaDetailsById_Media>
    loading?: boolean
