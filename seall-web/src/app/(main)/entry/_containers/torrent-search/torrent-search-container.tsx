import { Media_Entry, Debrid_TorrentItemInstantAvailability, HibikeTorrent_MediaTorrent } from "@/api/generated/types"
...
export const __torrentSearch_selectedTorrentsAtom = atom<HibikeTorrent_MediaTorrent[]>([])

export function TorrentSearchContainer({ type, entry }: { type: TorrentSelectionType, entry: Media_Entry }) {
     ...
     */
    const handleToggleTorrent = React.useCallback((t: HibikeTorrent_MediaTorrent) => {
        if (type === "download") {
