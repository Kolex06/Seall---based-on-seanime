import { Media_Entry, Media_EntryDownloadEpisode } from "@/api/generated/types"
...
export function TorrentSearchDrawer(props: { entry: Media_Entry, isPlaylistDrawer?: boolean }) {
...
function EpisodeList({ episodes }: { episodes: Media_EntryDownloadEpisode[] | undefined }) {
