import { Media_Entry, HibikeTorrent_MediaTorrent } from "@/api/generated/types"
...
export function getDefaultDestination(entry: Media_Entry, libraryPath?: string): string {
...
export function TorrentDownloadFileSelection({ entry }: { entry: Media_Entry }) {
