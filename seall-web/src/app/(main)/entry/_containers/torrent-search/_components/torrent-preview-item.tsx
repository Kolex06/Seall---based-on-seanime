import { MediaAPI_BaseMedia, Media_Episode, Habari_Metadata, HibikeTorrent_MediaTorrent } from "@/api/generated/types"
import {
...
export const TorrentListItem = ({ torrent, metadata, debridCached, onClick, isSelected, episode, media, overrideProps, extensionName, isSpoiler }: {
    ...
    episode: Media_Episode | undefined,
    media: MediaAPI_BaseMedia | undefined,
    isSelected: boolean
    onClick: () => void
