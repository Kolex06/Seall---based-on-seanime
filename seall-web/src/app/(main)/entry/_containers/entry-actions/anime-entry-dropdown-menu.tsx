...
import { useOpenMediaEntryInExplorer } from "@/api/hooks/media_entries.hooks"
...
export function AnimeEntryDropdownMenu({ entry, details }: { entry: Media_Entry, details?: MediaAPI_MediaDetailsById_Media }) {
    ...
    const { mutate: openEntryInExplorer } = useOpenMediaEntryInExplorer()
