...
export function DebridStreamPage(props: DebridStreamPageProps) {
    ...
    function handlePlayNextEpisodeOnMount(episode: Media_Episode) {
        if (autoSelect) {
    ...
    function handleSetDebridstreamAutoplayInfo(episode: Media_Episode | undefined) {
    ...
    function handleAutoSelect(entry: Media_Entry, episode: Media_Episode | undefined) {
        if (!episode || !episode.aniDBEpisode || !episodeCollection?.episodes) return
    ...
    const handleEpisodeClick = (episode: Media_Episode, forcePlaybackMethod?: ForcePlaybackMethod) => {
