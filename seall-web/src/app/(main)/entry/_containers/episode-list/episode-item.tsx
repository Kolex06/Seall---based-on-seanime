...
import { MediaAPI_BaseMedia, Media_Episode, Media_LocalFileType } from "@/api/generated/types"
...
export const EpisodeItem = memo(({ episode, media, isWatched, watchedProgress, onPlay, percentageComplete, minutesRemaining, onPlayExternally }: {
...
function MetadataModal({ episode }: { episode: Media_Episode }) {
...
export function EpisodeItemInfoModalButton({ episode }: { episode: Media_Episode }) {
