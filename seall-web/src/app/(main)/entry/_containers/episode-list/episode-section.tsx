import { MediaAPI_MediaDetailsById_Media, Media_Entry, Media_Episode } from "@/api/generated/types"
...
type EpisodeSectionProps = {
    entry: Media_Entry
    details: MediaAPI_MediaDetailsById_Media | undefined
        ...
        inject("library-episodes", {
            items: allEpisodes.filter(n => !!n.episodeTitle).map(episode => ({
                ...
                onSelect: () => playMediaFile({
                    ...
                    episode: episode as Media_Episode,
                }),
            })),
            filter: ({ item, input }) => {
