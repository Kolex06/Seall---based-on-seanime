import { Media_Entry, HibikeTorrent_MediaTorrent, HibikeTorrent_BatchEpisodeFiles } from "@/api/generated/types"
...
export const __torrentSearch_fileSelectionTorrentAtom = atom<HibikeTorrent_MediaTorrent | undefined>(undefined)

export function TorrentstreamFileSelectionModal({ entry }: { entry: Media_Entry }) {
