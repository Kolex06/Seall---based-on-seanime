import { useCustomSourceListMedia, useCustomSourceListManga } from "@/api/hooks/custom_source.hooks"
...
export default function Page() {
    ...
    const animeQuery = useCustomSourceListMedia({
        provider: provider || "",
                ...
                <AppLayoutStack>
                    ...
                    <div className="flex gap-2">
                        ...
                        <Select
                            className="w-full"
                            options={[
                                ...((supportsAnime || !supportsManga) ? [{ label: "Media", value: "anime" }] : []),
                                ...((supportsManga && !supportsAnime) ? [{ label: "Media", value: "manga" }] : []),
                            ]}
                            value={params.type}
