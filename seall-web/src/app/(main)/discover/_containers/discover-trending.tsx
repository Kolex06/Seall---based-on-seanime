import { MediaAPI_BaseMedia, MediaAPI_BaseManga } from "@/api/generated/types"
...
export const __discover_randomTrendingAtom = atom<MediaAPI_BaseMedia | MediaAPI_BaseManga | undefined>(undefined)
