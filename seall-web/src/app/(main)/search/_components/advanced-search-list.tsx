...
import { useMediaAdvancedSearch } from "@/app/(main)/search/_lib/handle-advanced-search"
...
export function AdvancedSearchList() {
    ...
    const { isLoading, data, fetchNextPage, hasNextPage, type } = useMediaAdvancedSearch()
