    ...
    useMount(() => {
        if (sortingUrlParam || genreUrlParam || statusUrlParam || formatUrlParam || seasonUrlParam || yearUrlParam || typeUrlParam || tagsUrlParam) {
            setParams({
                active: true,
                title: null,
                sorting: sortingUrlParam ? [sortingUrlParam as MediaAPI_MediaSort] : null,
                status: statusUrlParam ? [statusUrlParam as MediaAPI_MediaStatus] : null,
                genre: genreUrlParam ? [genreUrlParam] : null,
                tags: tagsUrlParam ? [tagsUrlParam] : null,
                format: (formatUrlParam as MediaAPI_MediaFormat) === "MANGA" ? null : (formatUrlParam as MediaAPI_MediaFormat),
                season: (seasonUrlParam as MediaAPI_MediaSeason) || null,
