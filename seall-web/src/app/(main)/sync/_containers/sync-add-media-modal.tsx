import { Media_LibraryCollection, Media_LibraryCollectionEntry, Manga_Collection, Manga_CollectionEntry } from "@/api/generated/types"
...
function MediaSelector(props: MediaSelectorProps) {
    ...
    function handleBatchSelectAnime(listType: string, entries: (Media_LibraryCollectionEntry | Manga_CollectionEntry)[], select: boolean) {
...
function MediaList(props: {
    collection: Media_LibraryCollection | Manga_Collection,
    entry: (entry: Media_LibraryCollectionEntry | Manga_CollectionEntry) => React.ReactElement,
    selectedMedia: { mediaId: number, type: "manga" | "anime" }[],
    savedMediaIds: number[],
    onBatchSelect: (listType: string, entries: (Media_LibraryCollectionEntry | Manga_CollectionEntry)[], select: boolean) => void
}) {
...
function MediaListSection(props: {
    listType: string
    title: string
    entries: (Media_LibraryCollectionEntry | Manga_CollectionEntry)[]
    selectedMedia: { mediaId: number, type: "manga" | "anime" }[]
    savedMediaIds: number[]
    onBatchSelect: (listType: string, entries: (Media_LibraryCollectionEntry | Manga_CollectionEntry)[], select: boolean) => void
    entry: (entry: Media_LibraryCollectionEntry | Manga_CollectionEntry) => React.ReactElement
...
function MediaItem(props: {
    entry: Media_LibraryCollectionEntry | Manga_CollectionEntry,
    onClick: () => void,
    onUntrack: () => void,
    isSelected: boolean,
    isSaved: boolean
