...
import { useGetUpcomingEpisodes } from "@/api/hooks/media_entries.hooks.ts"
...
/**
 * @description
 * Displays a carousel of upcoming releases based on the user's watchlist.
 */
export function UpcomingEpisodes() {
    ...
    const { data: animeCollection } = useGetMediaCollection()
            ...
            {data?.episodes.length > 0 && (
                <>
                    <div>
                        ...
                        <p className="text-[--muted]">Based on your watchlist</p>
                    </div>
