                                        ...
                                        >
                                            <div className="flex items-center gap-2">
                                                {!!media && <SeaLink
                                                    ...
                                                    href={`/reading/entry?id=${media.id}`}
                                    ...
                                    return (
                                        ...
                                        >
                                            <SeaLink
                                                ...
                                                href={`/reading/entry?id=${item.mediaId}`}
                                            >Media {item.mediaId}</SeaLink>

                                            <div className="flex items-center gap-2">
                                                <p>{Object.values(item.downloadData)
                                                    .flatMap(n => n).length} chapters</p> - <em className="text-[--muted]">Not in your SIMKL
                                                                                                                           collection</em>
                                            </div>
                                        </Card>
                                    )
