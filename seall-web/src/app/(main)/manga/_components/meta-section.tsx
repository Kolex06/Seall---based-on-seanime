import { MediaAPI_MangaDetailsById_Media, Manga_Entry } from "@/api/generated/types"
import {
    AnimeEntryRankings,
...
export function MetaSection(props: { entry: Manga_Entry | undefined, details: MediaAPI_MangaDetailsById_Media | undefined, detailsLoading?: boolean }) {

    const { entry, details, detailsLoading } = props
    const ts = useThemeSettings()

    if (!entry?.media) return null
    const mediaSiteUrl = entry.media.siteUrl
            ...
            <MediaPageHeaderDetailsContainer>
                ...
                <MediaPageHeaderEntryDetails
                    ...
                    after={<div className="w-full flex flex-wrap gap-4 items-center" data-manga-meta-section-buttons-container>
                        ...
                        {!isCustomSource(entry.mediaId) && mediaSiteUrl && <SeaLink href={mediaSiteUrl} target="_blank">
