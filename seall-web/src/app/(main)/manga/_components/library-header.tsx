import { MediaAPI_BaseManga } from "@/api/generated/types"
...
export const __mangaLibraryHeaderMangaAtom = atom<MediaAPI_BaseManga | null>(null)

const MotionImage = motion.create(SeaImage)

export function MangaLibraryHeader({ manga }: { manga: MediaAPI_BaseManga[] }) {
