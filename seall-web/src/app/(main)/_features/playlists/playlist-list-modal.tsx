import { Media_LibraryCollection, Media_LibraryCollectionList } from "@/api/generated/types"
                ...
                lists: [
                    {
                        ...
                        status: "CURRENT",
                        entries: entries,
                    } as Media_LibraryCollectionList,
...
function PlaylistLists({ libraryCollection }: { libraryCollection: Media_LibraryCollection | undefined }) {
