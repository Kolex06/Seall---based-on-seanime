import { Media_LibraryCollection, Media_LibraryCollectionEntry, Media_PlaylistEpisode, Media_WatchType, Nullish } from "@/api/generated/types"
...
export function playlist_isSameEpisode(a: Nullish<Media_PlaylistEpisode>, b: Nullish<Media_PlaylistEpisode>) {
    if (!a || !b) return false
...
export function playlist_getEpisodeKey(a: Media_PlaylistEpisode) {
...
type PlaylistEditorProps = {
    episodes: Media_PlaylistEpisode[]
    setEpisodes: (episodes: Media_PlaylistEpisode[]) => void
...
type PlaylistMediaEntryTriggerProps = {
    entry: Media_LibraryCollectionEntry
    episodes: Media_PlaylistEpisode[]
    setEpisodes: React.Dispatch<React.SetStateAction<Media_PlaylistEpisode[]>>
}
        ...
        <li ref={setNodeRef} style={style}>
            ...
            >
                <IconButton
                    ...
                    size="sm"
                    onClick={(e) => {
                        setEpisodes((prev: Media_PlaylistEpisode[]) => prev.filter(n => !playlist_isSameEpisode(n, episode)))
                    }}
                                    ...
                                    setEpisodes(prev => {
                                        ...
                                        return prev.map(n => {
                                            if (playlist_isSameEpisode(n, episode)) {
                                                return {
                                                    ...n,
                                                    watchType: (option.value === n.watchType ? "" : option.value) as Media_WatchType,
                                                }
                                            }
                                            return n
                                        })
...
type EntryEpisodeListProps = {
    entry: Media_LibraryCollectionEntry
    selectedEpisodes: Media_PlaylistEpisode[]
    setSelectedEpisodes: React.Dispatch<React.SetStateAction<Media_PlaylistEpisode[]>>
}
...
function EntryEpisodeList(props: EntryEpisodeListProps) {
    ...
    const handleSelect = (ep: Media_PlaylistEpisode) => {
    ...
    const allSelectedFn = (episodes: Media_PlaylistEpisode[],
        selectedEpisodes: Media_PlaylistEpisode[],
