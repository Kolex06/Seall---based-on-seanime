import { Media_LibraryCollection, Media_Playlist, Media_PlaylistEpisode } from "@/api/generated/types"
...
export function PlaylistEditorModal(props: PlaylistEditorModalProps) {
    ...
    const [episodes, setEpisodes] = React.useState<Media_PlaylistEpisode[]>([])
