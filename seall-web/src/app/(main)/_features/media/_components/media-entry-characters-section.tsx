import { MediaAPI_MediaDetailsById_Media, MediaAPI_MangaDetailsById_Media } from "@/api/generated/types"
...
type RelationsRecommendationsSectionProps = {
    details: MediaAPI_MediaDetailsById_Media | MediaAPI_MangaDetailsById_Media | undefined
    isMangaPage?: boolean
    loading?: boolean
}
