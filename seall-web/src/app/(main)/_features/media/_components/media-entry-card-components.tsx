import { MediaAPI_BaseManga_Title } from "@/api/generated/types"
import { MediaAPI_BaseMedia_Title } from "@/api/generated/types"
import { MediaAPI_BaseMedia_NextAiringEpisode, MediaAPI_MediaListStatus, MediaAPI_MediaStatus } from "@/api/generated/types"
...
type MediaEntryCardHoverPopupTitleSectionProps = {
    ...
    title: string
    allTitles?: MediaAPI_BaseMedia_Title | MediaAPI_BaseManga_Title | undefined
    season?: string
    year?: number
    format?: string
    onClick?: () => void
...
type AnimeEntryCardNextAiringProps = {
    nextAiring: MediaAPI_BaseMedia_NextAiringEpisode | undefined
}
