import { MediaAPI_BaseMedia, MediaAPI_BaseManga, MediaAPI_MediaStatus, Media_EntryListData, Manga_EntryListData, Nullish } from "@/api/generated/types"
...
type MediaPageHeaderEntryDetailsProps = {
    ...
    type: "anime" | "manga"
    offlineSimklAnimeEntryModal?: React.ReactNode
                ...
                >
                    ...
                    <div className="flex flex-wrap gap-3 lg:gap-4 items-center justify-center lg:justify-start">
                        ...
                        >
                            ...
                            <MediaEntryEditModal listData={listData} media={media} type={type} />
