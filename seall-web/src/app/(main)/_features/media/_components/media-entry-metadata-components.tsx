import { MediaAPI_MediaDetailsById_Media_Rankings, MediaAPI_MangaDetailsById_Media_Rankings } from "@/api/generated/types"
...
export function MediaEntryAudienceScore(props: MediaEntryAudienceScoreProps) {
    ...
    const hideAudienceScore = React.useMemo(() => status?.settings?.simkl?.hideAudienceScore ?? false,
        [status?.settings?.simkl?.hideAudienceScore])
...
type AnimeEntryRankingsProps = {
    rankings?: MediaAPI_MediaDetailsById_Media_Rankings[] | MediaAPI_MangaDetailsById_Media_Rankings[]
}
