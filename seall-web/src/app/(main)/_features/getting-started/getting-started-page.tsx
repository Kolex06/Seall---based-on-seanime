...
const STEPS = [
    {
        ...
        description: "Choose your media library folder",
        icon: BiFolder,
        ...
        >
            <motion.div variants={itemVariants} className="text-center space-y-4">
                ...
                <p className="text-[--muted] text-sm max-w-lg mx-auto">
                    Choose the folder where your media files are stored. This is where Seall will scan for your collection.
                </p>
            </motion.div>
            ...
            <StepCard className="max-w-2xl mx-auto">
                <motion.div variants={itemVariants}>
                    <Field.DirectorySelector
                        ...
                        shouldExist
                        help="Select the main folder containing your media collection. You can add more folders later."
                        className="w-full"
                    />
                </motion.div>
            </StepCard>
        ...
        >
            <motion.div variants={itemVariants} className="text-center space-y-4">
                ...
                {__isElectronDesktop__ && <div className="max-w-3xl mx-auto p-4 rounded-xl border !mb-8 font-medium">
                    Seall Denshi includes a built-in media player that is enabled by default. You can still configure an external media player.
                </div>}

                <h2 className="text-3xl font-bold">{__isDesktop__ ? "External " : ""}Media Player</h2>
                <p className="text-[--muted] text-sm max-w-lg mx-auto">
                    Configure your preferred external media player for watching media and tracking progress automatically.
                </p>
            </motion.div>
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        {defaultPlayer === "iina" && (
                            ...
                            >
                                ...
                                <Alert
                                    intent="info-basic"
                                    description={<p>For IINA to work correctly with Seall, make sure <strong>Quit after all windows are
                ...
                <StepCard>
                    <motion.div variants={itemVariants} className="space-y-4">
                        ...
                        <p className="text-sm text-[--muted]">
                            Client used to download media torrents
                        </p>
                        <Field.Select
...
function FeaturesStep({ form }: { form: any }) {
    const features = [
        ...
        },
        {
            ...
            description: "Watch from online sources",
