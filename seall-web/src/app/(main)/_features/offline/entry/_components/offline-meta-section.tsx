import { MediaAPI_BaseMedia, MediaAPI_BaseManga, Media_Entry, Manga_Entry } from "@/api/generated/types"
...
} from "@/app/(main)/_features/media/_components/media-page-header-components.tsx"
import React from "react"

type OfflineMetaSectionProps<T extends "anime" | "manga"> = {
    type: T,
    entry: T extends "anime" ? Media_Entry : Manga_Entry
}
        ...
        >
            ...
            <MediaPageHeaderDetailsContainer>
                ...
                <MediaPageHeaderEntryDetails
                    ...
                    progressTotal={type === "anime" ? (entry.media as MediaAPI_BaseMedia)?.episodes : (entry.media as MediaAPI_BaseManga)?.chapters}
