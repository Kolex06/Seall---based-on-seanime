import { MediaAPI_BaseMedia, MediaAPI_BaseManga, Media_Episode, Onlinestream_Episode } from "@/api/generated/types"
...
export function PluginAnimePageButtons(props: { media: MediaAPI_BaseMedia }) {
...
export function PluginMangaPageButtons(props: { media: MediaAPI_BaseManga }) {
...
export function PluginEpisodeCardContextMenuItems(props: { episode: Media_Episode | undefined, type: PluginEpisodeCardContextMenuItem["type"] }) {
...
export function PluginEpisodeGridItemMenuItems(props: {
    ...
    episode: Media_Episode | Onlinestream_Episode | undefined
}) {
...
export function PluginAnimePageDropdownItems(props: { media: MediaAPI_BaseMedia }) {
