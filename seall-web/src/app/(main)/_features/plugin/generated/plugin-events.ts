...
export enum PluginClientEvents {
    ...
    MediaEntryEpisodeTabsRender = "media:entry-episode-tabs:render",
    MediaEntryEpisodeTabOpen = "media:entry-episode-tab:open",
    MediaEntryEpisodeTabSelectEpisode = "media:entry-episode-tab:select-episode",
    MediaEntryEpisodeTabStateChanged = "media:entry-episode-tab:state-changed",
...
export enum PluginServerEvents {
    ...
    MediaEntryEpisodeTabsUpdated = "media:entry-episode-tabs:updated",
    MediaEntryEpisodeTabEpisodeCollection = "media:entry-episode-tab:episode-collection",
...
export type Plugin_Client_MediaEntryEpisodeTabsRenderEventPayload = {
    mediaId: number
}

export function usePluginSendMediaEntryEpisodeTabsRenderEvent() {
    const { sendPluginMessage } = useWebsocketSender()

    const sendMediaEntryEpisodeTabsRenderEvent = useCallback((payload: Plugin_Client_MediaEntryEpisodeTabsRenderEventPayload, extensionID?: string) => {
        sendPluginMessage(PluginClientEvents.MediaEntryEpisodeTabsRender, payload, extensionID)
    }, [])

    return {
        sendMediaEntryEpisodeTabsRenderEvent,
    }
}

export type Plugin_Client_MediaEntryEpisodeTabOpenEventPayload = {
    mediaId: number
}

export function usePluginSendMediaEntryEpisodeTabOpenEvent() {
    const { sendPluginMessage } = useWebsocketSender()

    const sendMediaEntryEpisodeTabOpenEvent = useCallback((payload: Plugin_Client_MediaEntryEpisodeTabOpenEventPayload, extensionID?: string) => {
        sendPluginMessage(PluginClientEvents.MediaEntryEpisodeTabOpen, payload, extensionID)
    }, [])
...
export type Plugin_Client_MediaEntryEpisodeTabSelectEpisodeEventPayload = {
    mediaId: number
...
export function usePluginSendMediaEntryEpisodeTabSelectEpisodeEvent() {
    const { sendPluginMessage } = useWebsocketSender()

    const sendMediaEntryEpisodeTabSelectEpisodeEvent = useCallback((payload: Plugin_Client_MediaEntryEpisodeTabSelectEpisodeEventPayload, extensionID?: string) => {
        sendPluginMessage(PluginClientEvents.MediaEntryEpisodeTabSelectEpisode, payload, extensionID)
    }, [])
...
export type Plugin_Client_MediaEntryEpisodeTabStateChangedEventPayload = {
    isOpen: boolean
}

export function usePluginSendMediaEntryEpisodeTabStateChangedEvent() {
    const { sendPluginMessage } = useWebsocketSender()

    const sendMediaEntryEpisodeTabStateChangedEvent = useCallback((payload: Plugin_Client_MediaEntryEpisodeTabStateChangedEventPayload, extensionID?: string) => {
        sendPluginMessage(PluginClientEvents.MediaEntryEpisodeTabStateChanged, payload, extensionID)
    }, [])
...
export type Plugin_Server_MediaEntryEpisodeTabsUpdatedEventPayload = {
    tabs: any
}

export function usePluginListenMediaEntryEpisodeTabsUpdatedEvent(cb: (payload: Plugin_Server_MediaEntryEpisodeTabsUpdatedEventPayload, extensionId: string) => void, extensionID: string) {
    return useWebsocketPluginMessageListener<Plugin_Server_MediaEntryEpisodeTabsUpdatedEventPayload>({
        extensionId: extensionID,
        type: PluginServerEvents.MediaEntryEpisodeTabsUpdated,
        onMessage: cb,
    })
}

export type Plugin_Server_MediaEntryEpisodeTabEpisodeCollectionEventPayload = {
    episodeCollection: any
}

export function usePluginListenMediaEntryEpisodeTabEpisodeCollectionEvent(cb: (payload: Plugin_Server_MediaEntryEpisodeTabEpisodeCollectionEventPayload, extensionId: string) => void, extensionID: string) {
    return useWebsocketPluginMessageListener<Plugin_Server_MediaEntryEpisodeTabEpisodeCollectionEventPayload>({
        extensionId: extensionID,
        type: PluginServerEvents.MediaEntryEpisodeTabEpisodeCollection,
        onMessage: cb,
    })
}
...
export function usePluginListenDOMGetViewportSizeEvent(cb: (payload: Plugin_Server_DOMGetViewportSizeEventPayload, extensionId: string) => void, extensionID: string) {
