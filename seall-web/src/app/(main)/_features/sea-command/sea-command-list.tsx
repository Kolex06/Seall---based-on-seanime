...
export function SeaCommandList() {
    ...
    const isAnimePage = (pathname === "/entry" || pathname === "/offline/entry/media") && Number.isFinite(mediaId) && mediaId > 0
    ...
    const commands = [
        ...
        {
            command: "library",
            description: "Find in your media library",
            show: true,
        },
        {
            command: "search",
            description: "Search on SIMKL",
            show: true,
        },
        {
            command: "magnet",
        ...
        {
            command: "spoilers",
            description: "Toggle spoilers for this media",
            show: isAnimePage,
        },
    ]
