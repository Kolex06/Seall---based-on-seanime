import { MediaAPI_BaseMedia_Title, MediaAPI_BaseManga_Title } from "@/api/generated/types"
...
export function seaCommand_compareMediaTitles(titles: Nullish<MediaAPI_BaseMedia_Title | MediaAPI_BaseManga_Title>, query: string) {
