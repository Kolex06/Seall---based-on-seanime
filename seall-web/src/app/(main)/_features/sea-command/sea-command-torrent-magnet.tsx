import { Media_Episode, HibikeTorrent_MediaTorrent } from "@/api/generated/types"
...
function createManualMagnetTorrent(magnetLink: string): HibikeTorrent_MediaTorrent {
...
function matchesEpisodeSearch(episode: Media_Episode, query: string) {
...
export function SeaCommandTorrentMagnet() {
    ...
    const { data: entry, isLoading: isEntryLoading } = useGetMediaEntry(selectedMediaId)
    const { data: episodeCollection, isLoading: isEpisodeLoading } = useGetMediaEpisodeCollection(selectedMediaId)
