...
function isAnimePage(pathname: string) {
    return pathname === "/entry" || pathname === "/offline/entry/media"
}
...
export function SeaCommandSpoilers() {
    ...
    const items = [
        {
            value: "on",
            description: "rehide spoilers for this media",
            enabled: true,
        },
        {
            value: "off",
            description: "unhide spoilers for this media",
            enabled: false,
        },
    ]
    ...
    return (
        <>
            <CommandHelperText
                ...
                description="unhide spoilers for the current media"
                show={query === ""}
            />
            <CommandHelperText
                command="/spoilers on"
                description="rehide spoilers for the current media"
                show={query === ""}
            />
