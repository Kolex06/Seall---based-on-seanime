import { Media_Episode, Media_LibraryCollectionEntry, Media_LibraryCollectionList } from "@/api/generated/types"
import {
...
import { MEDIA_COLLECTION_SORTING_OPTIONS } from "@/lib/helpers/filtering"
...
type LibraryViewProps = {
    ...
    continueWatchingList: Media_Episode[]
    isLoading: boolean
    hasEntries: boolean
...
const LibraryCollectionListItem = React.memo(({ list, streamingMediaIds, type }: {
    list: Media_LibraryCollectionList,
    streamingMediaIds: number[],
    type: "grid" | "carousel"
}) => {
...
const MergedLibraryCollectionList = React.memo(({ entries, streamingMediaIds, type }: {
    entries: Media_LibraryCollectionEntry[],
    streamingMediaIds: number[]
    type: "grid" | "carousel"
}) => {
        ...
        <AppLayoutStack className="px-4 xl:px-0" data-detailed-library-view-search-options-container>
            ...
            >
                <Select
                    ...
                    options={MEDIA_COLLECTION_SORTING_OPTIONS}
                ...
                {serverStatus?.settings?.simkl?.enableAdultContent && <div className="flex h-full items-center">
                    <Switch
                        label="Adult"
