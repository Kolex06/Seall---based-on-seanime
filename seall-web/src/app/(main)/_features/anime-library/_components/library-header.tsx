...
import { __libraryHeaderEpisodeAtom } from "@/app/(main)/_features/anime-library/_containers/continue-watching"
...
export function LibraryHeader({ list }: { list: Media_Episode[] }) {
