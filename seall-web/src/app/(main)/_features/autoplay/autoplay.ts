import { Media_Entry, Media_Episode, HibikeTorrent_MediaTorrent, HibikeTorrent_BatchEpisodeFiles } from "@/api/generated/types"
...
export const __autoplay_nextEpisodeAtom = atom<Media_Episode | null>(null)
...
export function useAutoPlaySelectedTorrent() {
    ...
    return {
        ...
        setAutoPlayTorrent: (torrent: HibikeTorrent_MediaTorrent,
            entry: Media_Entry,
...
export function useAutoplay() {
    ...
    const startAutoplay = (
        ...
        let episodeToPlay: Media_Episode | null = null
...
export function useNextEpisodeResolver(mediaId: number, currentEpisodeNumber: number) {
    const { data: animeEntry } = useGetMediaEntry(!!mediaId ? mediaId : null)
