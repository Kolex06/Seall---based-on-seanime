import { Media_LocalFile, LibraryExplorer_FileTreeNodeJSON } from "@/api/generated/types"
...
export const libraryExplorer_matchLocalFilesAtom = atom<Media_LocalFile[]>([])
export const libraryExplorer_resolveUnknownLocalFilesAtom = atom<Media_LocalFile[]>([])
