...
import { Media_LocalFileMetadata, Media_LocalFileType, LibraryExplorer_FileTreeNodeJSON } from "@/api/generated/types"
import {
...
type PreviewItem = {
    ...
    newName: string
    willChange: boolean
    originalMetadata?: Media_LocalFileMetadata
    newMetadata?: Media_LocalFileMetadata
...
function validateFileType(type: string): Media_LocalFileType {
    const validTypes: Media_LocalFileType[] = ["main", "special", "nc"]
    return validTypes.includes(type as Media_LocalFileType) ? type as Media_LocalFileType : "nc"
}
...
function parseEpisodeSearch(searchText: string): {
    ...
    types?: Media_LocalFileType[],
    excludeTypes?: Media_LocalFileType[]
} {
...
function applyMetadataEdits(
    originalMetadata: Media_LocalFileMetadata | undefined,
    metadataEdits: MetadataEdit[],
    index: number,
): Media_LocalFileMetadata | undefined {
    ...
    let typeChange: Media_LocalFileType | undefined = undefined
