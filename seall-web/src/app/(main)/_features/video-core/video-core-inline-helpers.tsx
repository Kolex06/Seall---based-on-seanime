...
import { useUpdateMediaEntryProgress } from "@/api/hooks/media_entries.hooks"
...
const vc_inlineHelper_progressUpdateData = atom<{ media: MediaAPI_BaseMedia, currentProgress: number, currentEpisodeNumber: number } | null>(null)
...
export function VideoCoreInlineHelperUpdateProgressButton() {
    ...
    const { mutate: updateProgress, isPending: isUpdatingProgress, isSuccess: _ } = useUpdateMediaEntryProgress(
