import { Media_Episode } from "@/api/generated/types"
...
type EpisodeCardProps = {
    ...
    episode?: Media_Episode // Optional, used for plugin actions
...
export function EpisodeCard(props: EpisodeCardProps) {
    ...
    const displayImage = spoiler.replaceImage
        ...
        : image
    const showAdultVeil = !!serverStatus?.settings?.simkl?.blurAdultContent && !!(isAdult ?? episode?.baseAnime?.isAdult)
                        ...
                        <ContextMenuItem
                            onClick={() => {
                                if (!serverStatus?.isOffline) {
                                    ...
                                    router.push(`/offline/entry/media?id=${anime?.id}`)
                                }
                            }}
                        >
                            <LuDock /> Open page
