import { MediaAPI_BaseMedia, Media_EntryLibraryData, Media_NakamaEntryLibraryData, Nullish } from "@/api/generated/types"
import { Badge } from "@/components/ui/badge"
import { cn } from "@/components/ui/core/styling"
import { simkl_getCurrentEpisodes } from "@/lib/helpers/media"
...
type AnimeEntryCardUnwatchedBadgeProps = {
    progress: number
    media: Nullish<MediaAPI_BaseMedia>
    libraryData: Nullish<Media_EntryLibraryData>
    nakamaLibraryData: Nullish<Media_NakamaEntryLibraryData>
}
...
export function AnimeEntryCardUnwatchedBadge(props: AnimeEntryCardUnwatchedBadgeProps) {
    ...
    const progressTotal = simkl_getCurrentEpisodes(media)
