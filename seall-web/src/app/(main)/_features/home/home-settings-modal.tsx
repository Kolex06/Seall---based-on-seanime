                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <RadioGroup
                            ...
                            options={[
                                { label: "Local media only", value: "local" },
                                { label: "Local media + Streaming", value: "stream" },
                            ]}
                        ...
                        <p className="text-sm text-[--muted] pt-4">
                            {animeLibraryType === "local"
                                ? "Only media in your local library will be displayed"
                                : "All media in your currently watching list will be included in the library"}
                        </p>
