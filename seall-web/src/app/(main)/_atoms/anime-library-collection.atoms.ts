import { Media_LibraryCollection, Media_LibraryCollectionEntry } from "@/api/generated/types"
import { atom } from "jotai"
import { derive } from "jotai-derive"
import { atomFamily } from "jotai-family"

export const animeLibraryCollectionAtom = atom<Media_LibraryCollection | undefined>(undefined)
export const animeLibraryCollectionWithoutStreamsAtom = derive([animeLibraryCollectionAtom], (animeLibraryCollection) => {
    ...
    } as Media_LibraryCollection
})

const animeLibraryEntryIndexAtom = atom<Record<number, Media_LibraryCollectionEntry>>((get) => {
    const index: Record<number, Media_LibraryCollectionEntry> = {}
