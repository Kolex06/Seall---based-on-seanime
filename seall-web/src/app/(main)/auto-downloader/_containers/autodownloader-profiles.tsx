import { Media_AutoDownloaderProfile } from "@/api/generated/types"
...
export function AutoDownloaderProfiles() {
    ...
    const [selectedProfile, setSelectedProfile] = React.useState<Media_AutoDownloaderProfile | null>(null)
...
function ProfileItem({ profile, onEdit }: { profile: Media_AutoDownloaderProfile, onEdit: () => void }) {
