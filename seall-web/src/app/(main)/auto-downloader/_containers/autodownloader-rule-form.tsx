...
export function useAutoDownloaderMediaList(allMedia: MediaAPI_BaseMedia[]) {
        ...
        if (type === "create") {
            createRule({
                rule: {
                    ...
                    episodeType: data.episodeType as Media_AutoDownloaderRuleEpisodeType,
                },
            }, {
...
export function RuleFormFields(props: RuleFormFieldsProps) {
    ...
    const form_episodeType = useWatch({ name: "episodeType" }) as Media_AutoDownloaderRuleEpisodeType
