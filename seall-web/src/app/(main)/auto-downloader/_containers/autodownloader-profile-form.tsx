import { Media_AutoDownloaderProfile, Media_AutoDownloaderProfileRuleFormatAction } from "@/api/generated/types"
...
type AutoDownloaderProfileFormProps = {
    profile?: Media_AutoDownloaderProfile
    onSuccess?: () => void
}
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const data = {
            ...
            conditions: formData.conditions.map(c => ({
                ...c,
                action: c.action as Media_AutoDownloaderProfileRuleFormatAction,
            })),
        }
