import { Media_AutoDownloaderRule } from "@/api/generated/types"
import {
...
export function AutoDownloaderPage() {
    ...
    function sortRules(a: Media_AutoDownloaderRule, b: Media_AutoDownloaderRule) {
                            ...
                            {(f) => (
                                <>
                                    ...
                                    >
                                        ...
                                        {/*    help="Seall will use smart search queries for more targeted results, if the extension allows it."*/}
                                        {/*/>*/}
                                        <Field.Switch
                                            side="right"
