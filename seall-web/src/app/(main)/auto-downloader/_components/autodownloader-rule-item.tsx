...
export type AutoDownloaderRuleItemProps = {
    ...
    profiles: Media_AutoDownloaderProfile[]
    extensions: ExtensionRepo_MediaTorrentProviderExtensionItem[]
}
...
function getEpisodeTypeName(episodeType: Media_AutoDownloaderRule["episodeType"]) {
    switch (episodeType) {
        case "recent":
