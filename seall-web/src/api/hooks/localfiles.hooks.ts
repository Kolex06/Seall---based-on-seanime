...
export function useLocalFileBulkAction() {
    ...
    return useServerMutation<Array<Media_LocalFile>, LocalFileBulkAction_Variables>({
        ...
        onSuccess: async () => {
            qc.invalidateQueries({ queryKey: [API_ENDPOINTS.MEDIA_LIBRARY.GetLibraryCollection.key] })
            qc.invalidateQueries({ queryKey: [API_ENDPOINTS.MEDIA_ENTRIES.GetMediaEntry.key] })
...
export function useUpdateLocalFileData() {
    ...
    const opts = useServerMutation<Array<Media_LocalFile>, UpdateLocalFileData_Variables>({
    ...
    return {
        updateLocalFile: (lf: Media_LocalFile, variables: Partial<UpdateLocalFileData_Variables>, onSuccess?: () => void) => {
            opts.mutate({
                path: lf.path,
...
export function useDeleteLocalFiles() {
    ...
    return useServerMutation<Array<Media_LocalFile>, DeleteLocalFiles_Variables>({
