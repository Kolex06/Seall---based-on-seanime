...
import {
    MediaAPI_ListManga,
    MediaAPI_MangaCollection,
    MediaAPI_MangaDetailsById_Media,
...
export function useListManga(variables: ListManga_Variables, enabled?: boolean) {
    return useServerQuery<MediaAPI_ListManga, ListManga_Variables>({
        endpoint: API_ENDPOINTS.MANGA.ListManga.endpoint,
        method: API_ENDPOINTS.MANGA.ListManga.methods[0],
        queryKey: [API_ENDPOINTS.MANGA.ListManga.key, variables],
        data: variables,
