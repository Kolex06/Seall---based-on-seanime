...
import { HibikeTorrent_MediaTorrent, Nullish, TorrentClient_Torrent } from "@/api/generated/types"
...
export function useTorrentClientGetFiles({ torrent, provider }: { torrent: Nullish<HibikeTorrent_MediaTorrent>, provider: Nullish<string> }) {
