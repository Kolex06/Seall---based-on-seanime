...
//     return useServerMutation<MediaAPI_MediaCollection>({
//         endpoint: API_ENDPOINTS.SIMKL.GetRawMediaCollection.endpoint,
//         method: API_ENDPOINTS.SIMKL.GetRawMediaCollection.methods[1],
//         mutationKey: [API_ENDPOINTS.SIMKL.GetRawMediaCollection.key],
//         onSuccess: async () => {
// 
//         },
//     })
...
//     return useServerQuery<MediaAPI_MediaTagMap>({
...
// export function useEditMediaListEntry() {
//     return useServerMutation<true, EditMediaListEntry_Variables>({
//         endpoint: API_ENDPOINTS.SIMKL.EditMediaListEntry.endpoint,
//         method: API_ENDPOINTS.SIMKL.EditMediaListEntry.methods[0],
//         mutationKey: [API_ENDPOINTS.SIMKL.EditMediaListEntry.key],
//         onSuccess: async () => {
// 
//         },
//     })
...
// export function useGetMediaDetails(id: number) {
...
//         queryKey: [API_ENDPOINTS.SIMKL.GetMediaDetails.key],
//         enabled: true,
//     })
// }
...
//         queryKey: [API_ENDPOINTS.SIMKL.GetStudioDetails.key],
//         enabled: true,
//     })
// }
...
//     return useServerMutation<MediaAPI_ListMedia, ListMedia_Variables>({
//         endpoint: API_ENDPOINTS.SIMKL.ListMedia.endpoint,
//         method: API_ENDPOINTS.SIMKL.ListMedia.methods[0],
//         mutationKey: [API_ENDPOINTS.SIMKL.ListMedia.key],
//         onSuccess: async () => {
// 
//         },
//     })
...
// export function useListRecentAiringMedia() {
//     return useServerMutation<MediaAPI_ListRecentMedia, ListRecentAiringMedia_Variables>({
//         endpoint: API_ENDPOINTS.SIMKL.ListRecentAiringMedia.endpoint,
//         method: API_ENDPOINTS.SIMKL.ListRecentAiringMedia.methods[0],
//         mutationKey: [API_ENDPOINTS.SIMKL.ListRecentAiringMedia.key],
//         onSuccess: async () => {
// 
//         },
//     })
...
// export function useListMissedSequels() {
...
// export function useGetMediaEpisodeCollection(id: number) {
...
//         queryKey: [API_ENDPOINTS.MEDIA_PLAYBACK.GetMediaEpisodeCollection.key],
//         enabled: true,
//     })
// }
...
// export function useGetLibraryCollection() {
//     return useServerMutation<Media_LibraryCollection>({
//         endpoint: API_ENDPOINTS.MEDIA_LIBRARY.GetLibraryCollection.endpoint,
//         method: API_ENDPOINTS.MEDIA_LIBRARY.GetLibraryCollection.methods[1],
//         mutationKey: [API_ENDPOINTS.MEDIA_LIBRARY.GetLibraryCollection.key],
//         onSuccess: async () => {
// 
//         },
//     })
...
// export function useGetMediaCollectionSchedule() {
//     return useServerQuery<Array<Media_ScheduleItem>>({
//         endpoint: API_ENDPOINTS.MEDIA_LIBRARY.GetMediaCollectionSchedule.endpoint,
//         method: API_ENDPOINTS.MEDIA_LIBRARY.GetMediaCollectionSchedule.methods[0],
//         queryKey: [API_ENDPOINTS.MEDIA_LIBRARY.GetMediaCollectionSchedule.key],
//         enabled: true,
//     })
// }
...
// export function useGetMediaEntry(id: number) {
...
//         queryKey: [API_ENDPOINTS.MEDIA_ENTRIES.GetMediaEntry.key],
//         enabled: true,
//     })
// }

// export function useMediaEntryBulkAction() {
...
//         mutationKey: [API_ENDPOINTS.MEDIA_ENTRIES.MediaEntryBulkAction.key],
//         onSuccess: async () => {
// 
//         },
//     })
...
// export function useGetMediaEntrySilenceStatus(id: number) {
...
// export function useUpdateMediaEntryProgress() {
...
//         mutationKey: [API_ENDPOINTS.MEDIA_ENTRIES.UpdateMediaEntryProgress.key],
//         onSuccess: async () => {
// 
//         },
//     })
...
// export function useUpdateMediaEntryRepeat() {
...
//         mutationKey: [API_ENDPOINTS.MEDIA_ENTRIES.UpdateMediaEntryRepeat.key],
//         onSuccess: async () => {
// 
//         },
//     })
...
//     return useServerQuery<Media_AutoDownloaderRule>({
...
//     return useServerQuery<Array<Media_AutoDownloaderRule>>({
...
//     return useServerMutation<Media_AutoDownloaderRule, CreateAutoDownloaderRule_Variables>({
...
//     return useServerMutation<Media_AutoDownloaderRule, UpdateAutoDownloaderRule_Variables>({
...
//     return useServerQuery<Array<Media_AutoDownloaderProfile>>({
...
//     return useServerQuery<Media_AutoDownloaderProfile>({
...
//     return useServerMutation<Media_AutoDownloaderProfile>({
...
// export function useCustomSourceListMedia() {
//     return useServerMutation<HibikeCustomSource_ListAnimeResponse, CustomSourceListMedia_Variables>({
...
//         mutationKey: [API_ENDPOINTS.CUSTOM_SOURCE.CustomSourceListMedia.key],
//         onSuccess: async () => {
// 
//         },
//     })
...
// export function useListMediaTorrentProviderExtensions() {
//     return useServerQuery<Array<ExtensionRepo_MediaTorrentProviderExtensionItem>>({
//         endpoint: API_ENDPOINTS.EXTENSIONS.ListMediaTorrentProviderExtensions.endpoint,
//         method: API_ENDPOINTS.EXTENSIONS.ListMediaTorrentProviderExtensions.methods[0],
//         queryKey: [API_ENDPOINTS.EXTENSIONS.ListMediaTorrentProviderExtensions.key],
//         enabled: true,
//     })
// }

// export function useListMediaEntryEpisodeTabExtensions() {
//     return useServerQuery<Array<ExtensionRepo_PluginEpisodeTabExtensionItem>>({
//         endpoint: API_ENDPOINTS.EXTENSIONS.ListMediaEntryEpisodeTabExtensions.endpoint,
//         method: API_ENDPOINTS.EXTENSIONS.ListMediaEntryEpisodeTabExtensions.methods[0],
//         queryKey: [API_ENDPOINTS.EXTENSIONS.ListMediaEntryEpisodeTabExtensions.key],
//         enabled: true,
//     })
// }
...
// export function useLocalSyncMediaData() {
//     return useServerMutation<boolean>({
//         endpoint: API_ENDPOINTS.LOCAL.LocalSyncMediaData.endpoint,
//         method: API_ENDPOINTS.LOCAL.LocalSyncMediaData.methods[0],
//         mutationKey: [API_ENDPOINTS.LOCAL.LocalSyncMediaData.key],
//         onSuccess: async () => {
// 
//         },
//     })
...
// export function useLocalSyncSimulatedDataToMedia() {
//     return useServerMutation<boolean>({
//         endpoint: API_ENDPOINTS.LOCAL.LocalSyncSimulatedDataToMedia.endpoint,
//         method: API_ENDPOINTS.LOCAL.LocalSyncSimulatedDataToMedia.methods[0],
//         mutationKey: [API_ENDPOINTS.LOCAL.LocalSyncSimulatedDataToMedia.key],
//         onSuccess: async () => {
// 
//         },
//     })
...
//     return useServerQuery<Array<Media_LocalFile>>({
...
//     return useServerMutation<Array<Media_LocalFile>, LocalFileBulkAction_Variables>({
...
//     return useServerMutation<Array<Media_LocalFile>, UpdateLocalFileData_Variables>({
...
// export function useGetSimklMangaCollection() {
//     return useServerQuery<MediaAPI_MangaCollection, GetMangaCollection_Variables>({
//         endpoint: API_ENDPOINTS.MANGA.GetSimklMangaCollection.endpoint,
//         method: API_ENDPOINTS.MANGA.GetSimklMangaCollection.methods[0],
//         queryKey: [API_ENDPOINTS.MANGA.GetSimklMangaCollection.key],
//         enabled: true,
//     })
// }

// export function useGetRawMangaCollection() {
//     return useServerQuery<MediaAPI_MangaCollection>({
//         endpoint: API_ENDPOINTS.MANGA.GetRawMangaCollection.endpoint,
//         method: API_ENDPOINTS.MANGA.GetRawMangaCollection.methods[0],
//         queryKey: [API_ENDPOINTS.MANGA.GetRawMangaCollection.key],
//         enabled: true,
//     })
// }

// export function useGetRawMangaCollection() {
//     return useServerMutation<MediaAPI_MangaCollection>({
//         endpoint: API_ENDPOINTS.MANGA.GetRawMangaCollection.endpoint,
//         method: API_ENDPOINTS.MANGA.GetRawMangaCollection.methods[1],
//         mutationKey: [API_ENDPOINTS.MANGA.GetRawMangaCollection.key],
//         onSuccess: async () => {
// 
//         },
//     })
...
// export function useGetRawMangaCollectionTags() {
//     return useServerQuery<MediaAPI_MediaTagMap>({
//         endpoint: API_ENDPOINTS.MANGA.GetRawMangaCollectionTags.endpoint,
//         method: API_ENDPOINTS.MANGA.GetRawMangaCollectionTags.methods[0],
//         queryKey: [API_ENDPOINTS.MANGA.GetRawMangaCollectionTags.key],
//         enabled: true,
//     })
// }
...
//     return useServerQuery<MediaAPI_MangaDetailsById_Media>({
...
// export function useListManga() {
//     return useServerMutation<MediaAPI_ListManga, ListManga_Variables>({
//         endpoint: API_ENDPOINTS.MANGA.ListManga.endpoint,
//         method: API_ENDPOINTS.MANGA.ListManga.methods[0],
//         mutationKey: [API_ENDPOINTS.MANGA.ListManga.key],
//         onSuccess: async () => {
// 
//         },
//     })
...
//     return useServerQuery<Media_LocalFile>({
...
//     return useServerMutation<Media_Playlist, CreatePlaylist_Variables>({
...
//     return useServerQuery<Array<Media_Playlist>>({
...
//     return useServerMutation<Media_Playlist, UpdatePlaylist_Variables>({
...
//     return useServerQuery<Array<Media_PlaylistEpisode>>({
...
//     return useServerQuery<Media_AutoSelectProfile>({
...
//     return useServerMutation<Media_AutoSelectProfile, SaveAutoSelectProfile_Variables>({
