...
import type {
    MediaAPI_AiringSort,
    MediaAPI_BaseMedia,
    MediaAPI_FuzzyDateInput,
    MediaAPI_MediaFormat,
    MediaAPI_MediaListStatus,
    MediaAPI_MediaSeason,
    MediaAPI_MediaSort,
    MediaAPI_MediaStatus,
    Media_AutoDownloaderRule,
    Media_AutoSelectProfile,
    Media_LocalFileMetadata,
    Media_PlaylistEpisode,
 ...
 */
export type EditMediaListEntry_Variables = {
    mediaId?: number
 ...
 */
export type GetMediaDetails_Variables = {
    /**
     *  The SIMKL anime ID
     */
    id: number
 ...
 */
export type GetStudioDetails_Variables = {
    /**
     *  The SIMKL studio ID
     */
    id: number
 ...
 */
export type DeleteMediaListEntry_Variables = {
    mediaId?: number
    type?: string
}
 ...
 */
export type ListMedia_Variables = {
    page?: number
    search?: string
    perPage?: number
    sort?: Array<MediaAPI_MediaSort>
    status?: Array<MediaAPI_MediaStatus>
    genres?: Array<string>
    tags?: Array<string>
 ...
 */
export type ListRecentAiringMedia_Variables = {
    page?: number
    search?: string
    perPage?: number
    ...
    notYetAired?: boolean
    sort?: Array<MediaAPI_AiringSort>
}
 ...
 */
export type GetMediaEpisodeCollection_Variables = {
    /**
     *  SIMKL anime media ID
     */
    id: number
}
 ...
 */
export type FetchMediaEntrySuggestions_Variables = {
    dir: string
}
 ...
 */
export type UpdateMediaEntryProgress_Variables = {
    mediaId: number
    malId?: number
 ...
 */
export type UpdateMediaEntryRepeat_Variables = {
    mediaId: number
    repeat: number
}
 ...
 */
export type GetAutoDownloaderRulesByMedia_Variables = {
    /**
     *  The SIMKL anime id of the rules
     */
    id: number
}
 ...
 */
export type CustomSourceListMedia_Variables = {
    provider: string
    search: string
    page: number
    perPage: number
 ...
 * @description
 * Route downloads, extracts, and installs macOS update, then closes the app
 */
export type DownloadMacDenshiUpdate_Variables = {
    download_url: string
    version: string
}
 ...
 * @description
 * Route sets the flag to determine if there are local changes that need to be synced with SIMKL.
 */
 ...
 * @description
 * Route returns the user's SIMKL manga collection.
 */
export type GetMangaCollection_Variables = {
    bypassCache: boolean
}
 ...
 */
export type ListManga_Variables = {
    page?: number
    search?: string
    perPage?: number
    sort?: Array<MediaAPI_MediaSort>
