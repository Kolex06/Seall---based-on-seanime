...
export const API_ENDPOINTS = {
    SIMKL: {
        /**
         *  @description
         *  Route returns the user's SIMKL anime collection.
         ...
         */
        GetMediaCollection: {
            key: "SIMKL-get-media-collection",
            methods: ["GET", "POST"],
            endpoint: "/api/v1/simkl/collection",
        },
        /**
         *  @description
         *  Route returns the user's SIMKL anime collection without filtering out custom lists.
         *  Calling GET will return the cached anime collection.
         */
        GetRawMediaCollection: {
            key: "SIMKL-get-raw-media-collection",
            methods: ["GET", "POST"],
            endpoint: "/api/v1/simkl/collection/raw",
        },
        /**
         *  @description
         *  Route returns the SIMKL tags for the user's raw anime collection.
         *  This runs a dedicated SIMKL tags query used by the lists page filters.
         */
        GetRawMediaCollectionTags: {
            key: "SIMKL-get-raw-media-collection-tags",
            methods: ["GET"],
            endpoint: "/api/v1/simkl/collection/raw/tags",
        },
        /**
         *  @description
         *  Route updates the user's list entry on Simkl.
         *  This is used to edit an entry on SIMKL.
         ...
         */
        EditMediaListEntry: {
            key: "SIMKL-edit-simkl-list-entry",
            methods: ["POST"],
            endpoint: "/api/v1/simkl/list-entry",
        },
        /**
         *  @description
         *  Route returns more details about an SIMKL anime entry.
         *  This fetches more fields omitted from the base queries.
         */
        GetMediaDetails: {
            key: "SIMKL-get-simkl-media-details",
            methods: ["GET"],
            endpoint: "/api/v1/simkl/media-details/{id}",
        },
        /**
         *  @description
         ...
         */
        GetStudioDetails: {
            key: "SIMKL-get-simkl-studio-details",
            methods: ["GET"],
            endpoint: "/api/v1/simkl/studio-details/{id}",
        },
        /**
         *  @description
         *  Route deletes an entry from the user's SIMKL list.
         *  This is used to delete an entry on SIMKL.
         *  The "type" field is used to determine if the entry is an anime or manga and refreshes the collection accordingly.
         *  The client should refetch collection-dependent queries after this mutation.
         */
        DeleteMediaListEntry: {
            key: "SIMKL-delete-simkl-list-entry",
            methods: ["DELETE"],
            endpoint: "/api/v1/simkl/list-entry",
        },
        /**
         ...
         */
        ListMedia: {
            key: "SIMKL-list-media",
            methods: ["POST"],
            endpoint: "/api/v1/simkl/list-media",
        },
        /**
         *  @description
         ...
         */
        ListRecentAiringMedia: {
            key: "SIMKL-list-recent-airing-media",
            methods: ["POST"],
            endpoint: "/api/v1/simkl/list-recent-airing-media",
        },
        /**
         *  @description
         ...
         */
        ListMissedSequels: {
            key: "SIMKL-simkl-list-missed-sequels",
            methods: ["GET"],
            endpoint: "/api/v1/simkl/list-missed-sequels",
        },
        /**
         *  @description
         *  Route returns the simkl stats.
         *  This returns the SIMKL stats for the user.
         */
        GetMediaStats: {
            key: "SIMKL-get-simkl-stats",
            methods: ["GET"],
            endpoint: "/api/v1/simkl/stats",
        },
        /**
         *  @description
         *  Route returns the status of the SIMKL cache layer.
         *  This returns the status of the SIMKL cache layer.
         */
        GetMediaCacheLayerStatus: {
            key: "SIMKL-get-simkl-cache-layer-status",
            methods: ["GET"],
            endpoint: "/api/v1/simkl/cache-layer/status",
        },
        /**
         *  @description
         *  Route toggles the status of the SIMKL cache layer.
         *  This toggles the status of the SIMKL cache layer.
         */
        ToggleMediaCacheLayerStatus: {
            key: "SIMKL-toggle-simkl-cache-layer-status",
            methods: ["POST"],
            endpoint: "/api/v1/simkl/cache-layer/status",
        },
    },
    MEDIA_PLAYBACK: {
         ...
         *  This returns a list of main episodes for the given SIMKL anime media id.
         *  It also loads the episode list into the different modules.
         */
        GetMediaEpisodeCollection: {
            key: "MEDIA-PLAYBACK-get-media-episode-collection",
            methods: ["GET"],
            endpoint: "/api/v1/media/episode-collection/{id}",
        },
    },
    MEDIA_LIBRARY: {
        /**
         ...
         *  It uses the cached Simkl anime collection for the GET method.
         *  It refreshes the SIMKL anime collection if the POST method is used.
         */
        GetLibraryCollection: {
            key: "MEDIA-LIBRARY-get-library-collection",
            methods: ["GET", "POST"],
         ...
         */
        GetMediaCollectionSchedule: {
            key: "MEDIA-LIBRARY-get-media-collection-schedule",
            methods: ["GET"],
            endpoint: "/api/v1/library/schedule",
        },
        /**
         *  @description
         *  Route adds the given media to the user's SIMKL planning collections
         *  Since media not found in the user's SIMKL collection are not displayed in the library, this route is used to add them.
         *  The response is ignored in the frontend, the client should just refetch the entire library collection.
         */
        AddUnknownMedia: {
            key: "MEDIA-LIBRARY-add-unknown-media",
            methods: ["POST"],
    ...
    MEDIA_ENTRIES: {
        /**
         *  @description
         *  Route return a media entry for the given SIMKL anime media id.
         *  This is used by the anime media entry pages to get all the data about the anime.
         *  This includes episodes and metadata (if any), SIMKL list data, download info...
         */
        GetMediaEntry: {
            key: "MEDIA-ENTRIES-get-media-entry",
            methods: ["GET"],
        ...
        MediaEntryBulkAction: {
            key: "MEDIA-ENTRIES-media-entry-bulk-action",
            methods: ["PATCH"],
        ...
        OpenMediaEntryInExplorer: {
            key: "MEDIA-ENTRIES-open-media-entry-in-explorer",
            methods: ["POST"],
         ...
         */
        FetchMediaEntrySuggestions: {
            key: "MEDIA-ENTRIES-fetch-media-entry-suggestions",
            methods: ["POST"],
        ...
        MediaEntryManualMatch: {
            key: "MEDIA-ENTRIES-media-entry-manual-match",
            methods: ["POST"],
         ...
         *  It detects missing episodes by comparing the user's SIMKL collection 'next airing' data with the local files.
         *  This route can be called multiple times, as it does not bypass the cache.
         */
        GetMissingEpisodes: {
            key: "MEDIA-ENTRIES-get-missing-episodes",
            methods: ["GET"],
         ...
         *  It uses the SIMKL 'next airing episode' data to determine upcoming episodes.
         *  This route can be called multiple times, as it does not bypass the cache.
         */
        GetUpcomingEpisodes: {
            key: "MEDIA-ENTRIES-get-upcoming-episodes",
            methods: ["GET"],
            endpoint: "/api/v1/library/upcoming-episodes",
        },
        GetMediaEntrySilenceStatus: {
            key: "MEDIA-ENTRIES-get-media-entry-silence-status",
            methods: ["GET"],
        ...
        ToggleMediaEntrySilenceStatus: {
            key: "MEDIA-ENTRIES-toggle-media-entry-silence-status",
            methods: ["POST"],
         ...
         *  This is used to update the progress of the given anime media entry on SIMKL.
         *  The response is not used in the frontend, the client should just refetch the entire media entry data.
         ...
         */
        UpdateMediaEntryProgress: {
            key: "MEDIA-ENTRIES-update-media-entry-progress",
            methods: ["POST"],
            endpoint: "/api/v1/library/media-entry/update-progress",
        },
        /**
         *  @description
         *  Route update the repeat value of the given anime media entry.
         *  This is used to update the repeat value of the given anime media entry on SIMKL.
         *  The response is not used in the frontend, the client should just refetch the entire media entry data.
         */
        UpdateMediaEntryRepeat: {
            key: "MEDIA-ENTRIES-update-media-entry-repeat",
            methods: ["POST"],
            endpoint: "/api/v1/library/media-entry/update-repeat",
        },
    },
    AUTH: {
        /**
         ...
         *  This is called when the JWT token is obtained from SIMKL after logging in with redirection on the client.
         *  It also fetches the Viewer data from SIMKL and saves it in the database.
    ...
    AUTO_DOWNLOADER: {
        ...
        GetAutoDownloaderRulesByAnime: {
            ...
            methods: ["GET"],
            endpoint: "/api/v1/auto-downloader/rule/media/{id}",
        },
        /**
         *  @description
    ...
    CUSTOM_SOURCE: {
         ...
         */
        CustomSourceListMedia: {
            key: "CUSTOM-SOURCE-custom-source-list-media",
            methods: ["POST"],
            endpoint: "/api/v1/custom-source/provider/list/media",
        },
        /**
         *  @description
        ...
        CustomSourceListManga: {
            ...
            methods: ["POST"],
            endpoint: "/api/v1/custom-source/provider/list/reading",
        },
    },
    DEBRID: {
        /**
    ...
    EXTENSIONS: {
        ...
        ListMangaProviderExtensions: {
            ...
            methods: ["GET"],
            endpoint: "/api/v1/extensions/list/reading-provider",
        },
        ...
        ListMediaTorrentProviderExtensions: {
            key: "EXTENSIONS-list-media-torrent-provider-extensions",
            methods: ["GET"],
            endpoint: "/api/v1/extensions/list/media-torrent-provider",
        },
        ListMediaEntryEpisodeTabExtensions: {
            key: "EXTENSIONS-list-media-entry-episode-tab-extensions",
            methods: ["GET"],
            endpoint: "/api/v1/extensions/list/media-entry-episode-tabs",
        },
    ...
    LOCAL: {
        ...
        LocalSyncMediaData: {
            key: "LOCAL-local-sync-simkl-data",
            methods: ["POST"],
            endpoint: "/api/v1/local/simkl",
        },
        ...
        LocalSyncSimulatedDataToMedia: {
            key: "LOCAL-local-sync-simulated-data-to-simkl",
            methods: ["POST"],
            endpoint: "/api/v1/local/sync-simulated-to-simkl",
        },
    },
    LOCALFILES: {
        /**
    ...
    MANGA: {
        GetSimklMangaCollection: {
            key: "MANGA-get-simkl-manga-collection",
            methods: ["GET"],
            endpoint: "/api/v1/reading/simkl/collection",
        },
        GetRawMangaCollection: {
            key: "MANGA-get-raw-simkl-manga-collection",
            methods: ["GET", "POST"],
            endpoint: "/api/v1/reading/simkl/collection/raw",
        },
        /**
         *  @description
         *  Route returns the SIMKL tags for the user's raw manga collection.
         *  This runs a dedicated SIMKL tags query used by the lists page filters.
         */
        GetRawMangaCollectionTags: {
            key: "MANGA-get-raw-simkl-manga-collection-tags",
            methods: ["GET"],
            endpoint: "/api/v1/reading/simkl/collection/raw/tags",
        },
        /**
         *  @description
        ...
        GetMangaCollection: {
            ...
            methods: ["GET"],
            endpoint: "/api/v1/reading/collection",
        },
        /**
         *  @description
         *  Route returns a manga entry for the given SIMKL manga id.
         *  This is used by the manga media entry pages to get all the data about the anime. It includes metadata and SIMKL list data.
         */
        GetMangaEntry: {
            key: "MANGA-get-manga-entry",
            methods: ["GET"],
            endpoint: "/api/v1/reading/entry/{id}",
        },
        /**
         *  @description
         *  Route returns more details about an SIMKL manga entry.
         *  This fetches more fields omitted from the base queries.
         */
        GetMangaEntryDetails: {
            key: "MANGA-get-manga-entry-details",
            methods: ["GET"],
            endpoint: "/api/v1/reading/entry/{id}/details",
        },
        GetMangaLatestChapterNumbersMap: {
            key: "MANGA-get-manga-latest-chapter-numbers-map",
            methods: ["GET"],
            endpoint: "/api/v1/reading/latest-chapter-numbers",
        },
        RefetchMangaChapterContainers: {
            key: "MANGA-refetch-manga-chapter-containers",
            methods: ["POST"],
            endpoint: "/api/v1/reading/refetch-chapter-containers",
        },
        /**
         *  @description
        ...
        EmptyMangaEntryCache: {
            ...
            methods: ["DELETE"],
            endpoint: "/api/v1/reading/entry/cache",
        },
        GetMangaEntryChapters: {
            key: "MANGA-get-manga-entry-chapters",
            methods: ["POST"],
            endpoint: "/api/v1/reading/chapters",
        },
        /**
         *  @description
         ...
         */
        ListManga: {
            key: "MANGA-simkl-list-manga",
            methods: ["POST"],
            endpoint: "/api/v1/reading/simkl/list",
        },
        /**
         *  @description
        ...
        UpdateMangaProgress: {
            ...
            methods: ["POST"],
            endpoint: "/api/v1/reading/update-progress",
        },
        /**
         *  @description
        ...
        MangaManualSearch: {
            ...
            methods: ["POST"],
            endpoint: "/api/v1/reading/search",
        },
        /**
         *  @description
        ...
        MangaManualMapping: {
            ...
            methods: ["POST"],
            endpoint: "/api/v1/reading/manual-mapping",
        },
        /**
         *  @description
        ...
        GetMangaMapping: {
            ...
            methods: ["POST"],
            endpoint: "/api/v1/reading/get-mapping",
        },
        /**
         *  @description
        ...
        RemoveMangaMapping: {
            ...
            methods: ["POST"],
            endpoint: "/api/v1/reading/remove-mapping",
        },
        GetLocalMangaPage: {
            key: "MANGA-get-local-manga-page",
            methods: ["GET"],
            endpoint: "/api/v1/reading/local-page/{path}",
        },
    },
    MANGA_DOWNLOAD: {
        DownloadMangaChapters: {
            ...
            methods: ["POST"],
            endpoint: "/api/v1/reading/download-chapters",
        },
        /**
         *  @description
        ...
        GetMangaDownloadData: {
            ...
            methods: ["POST"],
            endpoint: "/api/v1/reading/download-data",
        },
        GetMangaDownloadQueue: {
            key: "MANGA-DOWNLOAD-get-manga-download-queue",
            methods: ["GET"],
            endpoint: "/api/v1/reading/download-queue",
        },
        /**
         *  @description
        ...
        StartMangaDownloadQueue: {
            ...
            methods: ["POST"],
            endpoint: "/api/v1/reading/download-queue/start",
        },
        /**
         *  @description
        ...
        StopMangaDownloadQueue: {
            ...
            methods: ["POST"],
            endpoint: "/api/v1/reading/download-queue/stop",
        },
        /**
         *  @description
        ...
        ResetErroredChapterDownloadQueue: {
            ...
            methods: ["POST"],
            endpoint: "/api/v1/reading/download-queue/reset-errored",
        },
        /**
         *  @description
        ...
        DeleteMangaDownloadedChapters: {
            ...
            methods: ["DELETE"],
            endpoint: "/api/v1/reading/download-chapter",
        },
        /**
         *  @description
         ...
         *  It returns a list of manga.DownloadListItem where the media data might be nil if it's not in the SIMKL collection.
         */
        GetMangaDownloadsList: {
            key: "MANGA-DOWNLOAD-get-manga-downloads-list",
            methods: ["GET"],
            endpoint: "/api/v1/reading/downloads",
        },
    },
    MANUAL_DUMP: {
        TestDump: {
    ...
    NAKAMA: {
        ...
        GetNakamaAnimeLibrary: {
            ...
            methods: ["GET"],
            endpoint: "/api/v1/nakama/host/media/library",
        },
        /**
         *  @description
        ...
        GetNakamaAnimeLibraryShared: {
            ...
            methods: ["GET"],
            endpoint: "/api/v1/nakama/host/media/library/shared",
        },
        /**
         *  @description
         *  Route return the local files for the given SIMKL anime media id.
         *  This is used by the anime media entry pages to get all the data about the anime.
         */
        GetNakamaAnimeLibraryFiles: {
            key: "NAKAMA-get-nakama-anime-library-files",
            methods: ["POST"],
            endpoint: "/api/v1/nakama/host/media/library/files/{id}",
        },
        /**
         *  @description
        ...
        GetNakamaAnimeAllLibraryFiles: {
            ...
            methods: ["POST"],
            endpoint: "/api/v1/nakama/host/media/library/files",
        },
        NakamaPlayVideo: {
        ...
        /**
         *  @description
         *  Route creates a Seall Room and connects to it as host.
         *  This creates a room on the Seall Rooms relay server and connects as the host. Peers can then join using the returned URL.
         */
    ...
    ONLINESTREAM: {
        ...
        /**
         *  @description
         *  Route manually maps a media entry to a provider media ID.
         *  This is used to manually map a media entry to a provider media ID.
         *  The client should re-fetch the chapter container after this.
         */
        ...
        /**
         *  @description
         *  Route returns the mapping for a media entry.
         *  This is used to get the mapping for a media entry.
         *  An empty string is returned if there's no manual mapping. If there is, the provider media ID will be returned.
         */
        ...
        /**
         *  @description
         *  Route removes the mapping for a media entry.
         *  This is used to remove the mapping for a media entry.
         *  The client should re-fetch the chapter container after this.
         */
    ...
    PLAYBACK_MANAGER: {
        ...
        /**
         *  @description
         *  Route updates the SIMKL progress of the currently playing media.
    ...
    STATUS: {
         ...
         *  This returns the content of the most recent seall- log file after flushing logs.
         */
        GetLatestLogContent: {
