...
func TestNewTestEnv_CreatesIsolatedPaths(t *testing.T) {
	...
	assert.Contains(t, first.Config().Database.Name, "seall-test-")
}
...
func TestShouldRecordMediaApiFixtures(t *testing.T) {
	t.Setenv(RecordMediaApiFixturesEnvName, "true")
	assert.True(t, ShouldRecordMediaApiFixtures())

	t.Setenv(RecordMediaApiFixturesEnvName, "false")
	assert.False(t, ShouldRecordMediaApiFixtures())

	t.Setenv(RecordMediaApiFixturesEnvName, "not-a-bool")
	assert.False(t, ShouldRecordMediaApiFixtures())
}
