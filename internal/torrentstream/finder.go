...
import (
	...
	"seall/internal/util"
	"seall/internal/util/torrentutil"
...
func (r *Repository) findBestTorrent(media *mediaapi.CompleteAnime, aniDbEpisode string, episodeNumber int) (ret *playbackTorrent, err error) {
...
func (r *Repository) findBestTorrentFromManualSelection(t *hibiketorrent.MediaTorrent, media *mediaapi.CompleteAnime, aniDbEpisode string, chosenFileIndex *int) (*playbackTorrent, error) {
