...
type (
	Repository struct {
		...
		selectionHistoryMap *result.Map[int, *hibiketorrent.MediaTorrent] // Key: SIMKL media ID

		autoSelect *autoselect.AutoSelect

		// Injected dependencies
		torrentRepository               *torrent.Repository
		baseAnimeCache                  *mediaapi.BaseAnimeCache
...
func NewRepository(opts *NewRepositoryOptions) *Repository {
	ret := &Repository{
		...
		selectionHistoryMap:             result.NewMap[int, *hibiketorrent.MediaTorrent](),
...
func (r *Repository) getDefaultDownloadPath() string {
	tempDir := os.TempDir()
	downloadDirPath := filepath.Join(tempDir, "seall", "torrentstream")
