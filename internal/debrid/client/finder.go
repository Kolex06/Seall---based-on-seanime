...
import (
	...
	torrentanalyzer "seall/internal/torrents/analyzer"
...
func (r *Repository) findBestTorrent(provider debrid.Provider, media *mediaapi.CompleteAnime, episodeNumber int) (ret *playbackTorrent, err error) {
	...
	postSearchSort := func(torrents []*hibiketorrent.MediaTorrent) []*autoselect.TorrentWithCacheStatus {
		if len(torrents) == 0 {
...
func (r *Repository) findBestTorrentFromManualSelection(provider debrid.Provider, t *hibiketorrent.MediaTorrent, media *mediaapi.CompleteAnime, episodeNumber int, chosenFileIndex *int) (ret *playbackTorrent, err error) {
