...
type (
	...
	TorrentItem struct {
		...
		IsQueuedForLocalDownload bool               `json:"isQueuedForLocalDownload,omitempty"` // Whether Seall has queued this torrent for local download
		IsDownloadingLocally     bool               `json:"isDownloadingLocally,omitempty"`     // Whether Seall is currently downloading this torrent locally
