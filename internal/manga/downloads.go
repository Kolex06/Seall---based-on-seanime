...
func (r *Repository) GetDownloadedMangaChapterContainers(mId int, mangaCollection *mediaapi.MangaCollection) (ret []*ChapterContainer, err error) {
...
func (r *Repository) GetDownloadedChapterContainers(mangaCollection *mediaapi.MangaCollection) (ret []*ChapterContainer, err error) {
