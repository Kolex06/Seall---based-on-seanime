...
type Settings struct {
	...
	Simkl          *SimklSettings          `gorm:"embedded" json:"simkl"`
...
type SimklSettings struct {
	//MediaApiClientId    string `gorm:"column:simkl_client_id" json:"simklClientId"`
...
type LibrarySettings struct {
	...
	UpdateChannel            string `gorm:"column:update_channel" json:"updateChannel"` // "github", "seall", "seall_nightly"
	// v3.7.0+
...
type DiscordSettings struct {
	...
	RichPresenceHideSeallRepositoryButton bool `gorm:"column:rich_presence_hide_seall_repository_button" json:"richPresenceHideSeallRepositoryButton"`
	RichPresenceShowSIMKLMediaButton      bool `gorm:"column:rich_presence_show_simkl_media_button" json:"richPresenceShowSIMKLMediaButton"`
	RichPresenceShowSIMKLProfileButton    bool `gorm:"column:rich_presence_show_simkl_profile_button" json:"richPresenceShowSIMKLProfileButton"`
...
type OnlinestreamMapping struct {
	...
	Provider        string `gorm:"column:provider" json:"provider"`
	MediaID         int    `gorm:"column:media_id" json:"mediaId"`
	ProviderMediaID string `gorm:"column:provider_media_id" json:"providerMediaId"` // Provider ID from search result, used to fetch stream items.
}
...
// CustomSourceCollection is parallel to the SIMKL collection, it stores custom source media.
