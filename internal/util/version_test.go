...
func TestValidateReleaseUrl(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			url:            "https://github.com/Kolex06/Seall---based-on-seanime/releases/download/v3.5.1/seall-denshi-3.5.1_MacOS_arm64.dmg",
			expectedOutput: true,
		},
		{
			url:            "https://github.com/rando/seall/releases/download/v3.5.1/seall-denshi-3.5.1_MacOS_arm64.dmg",
			expectedOutput: false,
		},
		{
			url:            "https://example.com/api/updates/stable/seall-denshi-3.5.1_MacOS_arm64.dmg",
			expectedOutput: false,
		},
		{
