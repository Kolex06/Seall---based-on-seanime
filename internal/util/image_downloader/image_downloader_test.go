...
func TestImageDownloader_DownloadImages(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "test1",
			urls: []string{
				"https://s4.simkl.co/file/simklcdn/media/anime/banner/153518-7uRvV7SLqmHV.jpg",
				"https://s4.simkl.co/file/simklcdn/media/anime/banner/153518-7uRvV7SLqmHV.jpg",
				"https://s4.simkl.co/file/simklcdn/media/anime/cover/medium/bx153518-LEK6pAXtI03D.jpg",
			},
		...
		//{
		//	name:        "test1",
		//	urls:        []string{"https://s4.simkl.co/file/simklcdn/media/anime/banner/153518-7uRvV7SLqmHVn.jpg"},
		//	downloadDir: t.TempDir(),
		//	cancelAfter: 0,
		//},
	}
