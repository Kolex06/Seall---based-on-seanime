...
const (
	AddUnknownMediaEndpoint                            = "MEDIA-LIBRARY-add-unknown-media"
	ListMediaEndpoint                                  = "SIMKL-list-media"
	ListMangaEndpoint                                  = "MANGA-simkl-list-manga"
	ListMissedSequelsEndpoint                          = "SIMKL-simkl-list-missed-sequels"
	ListRecentAiringMediaEndpoint                      = "SIMKL-list-recent-airing-media"
	MediaEntryBulkActionEndpoint                       = "MEDIA-ENTRIES-media-entry-bulk-action"
	MediaEntryManualMatchEndpoint                      = "MEDIA-ENTRIES-media-entry-manual-match"
	...
	CustomSourceListMediaEndpoint                      = "CUSTOM-SOURCE-custom-source-list-media"
	...
	DeleteMediaListEntryEndpoint                       = "SIMKL-delete-simkl-list-entry"
	...
	EditMediaListEntryEndpoint                         = "SIMKL-edit-simkl-list-entry"
	...
	FetchMediaEntrySuggestionsEndpoint                 = "MEDIA-ENTRIES-fetch-media-entry-suggestions"
	...
	GetMediaStatsEndpoint                              = "SIMKL-get-simkl-stats"
	GetMediaDetailsEndpoint                            = "SIMKL-get-simkl-media-details"
	GetMediaCacheLayerStatusEndpoint                   = "SIMKL-get-simkl-cache-layer-status"
	GetSimklMangaCollectionEndpoint                    = "MANGA-get-simkl-manga-collection"
	GetStudioDetailsEndpoint                           = "SIMKL-get-simkl-studio-details"
	GetMediaCollectionEndpoint                         = "SIMKL-get-media-collection"
	GetMediaCollectionScheduleEndpoint                 = "MEDIA-LIBRARY-get-MEDIA-LIBRARY-schedule"
	GetMediaEntryEndpoint                              = "MEDIA-ENTRIES-get-media-entry"
	GetMediaEntrySilenceStatusEndpoint                 = "MEDIA-ENTRIES-get-media-entry-silence-status"
	GetMediaEpisodeCollectionEndpoint                  = "MEDIA-PLAYBACK-get-media-episode-collection"
	...
	GetLibraryCollectionEndpoint                       = "MEDIA-LIBRARY-get-library-collection"
	...
	GetMissingEpisodesEndpoint                         = "MEDIA-ENTRIES-get-missing-episodes"
	...
	GetRawSimklMangaCollectionEndpoint                 = "MANGA-get-raw-simkl-manga-collection"
	GetRawSimklMangaCollectionTagsEndpoint             = "MANGA-get-raw-simkl-manga-collection-tags"
	GetRawMediaCollectionEndpoint                      = "SIMKL-get-raw-media-collection"
	GetRawMediaCollectionTagsEndpoint                  = "SIMKL-get-raw-media-collection-tags"
	...
	GetUpcomingEpisodesEndpoint                        = "MEDIA-ENTRIES-get-upcoming-episodes"
	...
	ListMediaEntryEpisodeTabExtensionsEndpoint         = "EXTENSIONS-list-media-entry-episode-tab-extensions"
	ListMediaTorrentProviderExtensionsEndpoint         = "EXTENSIONS-list-media-torrent-provider-extensions"
	...
	LocalSyncMediaDataEndpoint                         = "LOCAL-local-sync-simkl-data"
	LocalSyncDataEndpoint                              = "LOCAL-local-sync-data"
	LocalSyncSimulatedDataToMediaEndpoint              = "LOCAL-local-sync-simulated-data-to-simkl"
	...
	OpenMediaEntryInExplorerEndpoint                   = "MEDIA-ENTRIES-open-media-entry-in-explorer"
	...
	ToggleMediaCacheLayerStatusEndpoint                = "SIMKL-toggle-simkl-cache-layer-status"
	ToggleMediaEntrySilenceStatusEndpoint              = "MEDIA-ENTRIES-toggle-media-entry-silence-status"
	...
	UpdateMediaEntryProgressEndpoint                   = "MEDIA-ENTRIES-update-media-entry-progress"
	UpdateMediaEntryRepeatEndpoint                     = "MEDIA-ENTRIES-update-media-entry-repeat"
