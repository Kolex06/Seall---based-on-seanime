...
const (
	ServerReady = "server-ready" // The simkl data has been loaded

	ServerLoggedOutSimkl = "server-logged-out-simkl" // The server has logged out of simkl (without the client requesting it)

	EventScanProgress         = "scan-progress"                // Progress of the scan
	EventScanStatus           = "scan-status"                  // Status text of the scan
	RefreshedMediaCollection  = "refreshed-media-collection"   // The simkl collection has been refreshed
	RefreshedMangaCollection  = "refreshed-manga-collection"   // The manga collection has been refreshed
	...
	SyncMediaFinished   = "sync-media-finished"
