...
type User struct {
	Viewer *mediaapi.GetViewer_Viewer `json:"viewer"`
	Token  string                     `json:"token"`
	// IsSimulated indicates whether the user is not a real SIMKL account.
...
func NewUser(model *models.Account) (*User, error) {
	...
	var acc mediaapi.GetViewer_Viewer
