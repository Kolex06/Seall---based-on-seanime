...
func TestFileHydrator_HydrateMetadata(t *testing.T) {
	...
	tests := []struct {
		...
		{
			// anidb lists 1 main episode but simkl lists 5
			// the media tree analysis should use the simkl episode count so normalize the episode numbers
