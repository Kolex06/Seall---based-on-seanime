...
type (
	playlistHub struct {
		...
		playingMediaListEntry *mediaapi.AnimeListEntry // The currently playing media entry
...
func (h *playlistHub) check(currListEntry *mediaapi.AnimeListEntry, currLf *anime.LocalFile, ps PlaybackState) bool {
...
func (h *playlistHub) onVideoStart(currListEntry *mediaapi.AnimeListEntry, currLf *anime.LocalFile, ps PlaybackState) {
...
func (h *playlistHub) onVideoCompleted(currListEntry *mediaapi.AnimeListEntry, currLf *anime.LocalFile, ps PlaybackState) {
	if !h.check(currListEntry, currLf, ps) {
		return
	}
...
func (h *playlistHub) onPlaybackStatus(currListEntry *mediaapi.AnimeListEntry, currLf *anime.LocalFile, ps PlaybackState) {
	if !h.check(currListEntry, currLf, ps) {
		return
	}
