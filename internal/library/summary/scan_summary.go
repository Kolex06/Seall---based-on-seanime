...
type (
	...
	ScanSummaryLogger struct {
		...
		AnimeCollection *mediaapi.AnimeCollectionWithRelations
	}
	...
	ScanSummaryGroup struct {
		...
		MediaIsInCollection bool               `json:"mediaIsInCollection"` // Whether the media is in the user's SIMKL collection
	}
...
func (l *ScanSummaryLogger) HydrateData(lfs []*anime.LocalFile, media []*anime.NormalizedMedia, animeCollection *mediaapi.AnimeCollectionWithRelations) {
	l.LocalFiles = lfs
	l.AllMedia = media
