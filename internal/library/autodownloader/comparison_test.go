...
func TestComparison(t *testing.T) {
	...
	aniListEntry := &mediaapi.AnimeListEntry{
	...
	rule := &anime.AutoDownloaderRule{
		...
		Destination:         "/data/seall/library/[Oshi no Ko] 2nd Season",
	...
	//	{
	//		Path: "/data/seall/library/[Oshi no Ko] 2nd Season/[SubsPlease] Oshi no Ko - 12 (1080p).mkv",
...
func TestComparison2(t *testing.T) {
	...
	rule := &anime.AutoDownloaderRule{
		...
		EpisodeType:         "recent",
		EpisodeNumbers:      []int{},
		Destination:         "/data/seall/library/Dandadan",
...
func TestComparison3(t *testing.T) {
	...
	//lfw := anime.NewLocalFileWrapper([]*anime.LocalFile{
	//	{
	//		Path: "/data/seall/library/Dandadan/[SubsPlease] Dandadan - 01 (1080p).mkv",
