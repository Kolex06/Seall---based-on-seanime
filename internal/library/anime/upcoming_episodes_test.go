...
func TestNewUpcomingEpisodesSortsAndHydratesMetadata(t *testing.T) {
	...
	patchAnimeCollectionEntry(t, h.animeCollection, 154587, mediaapi.AnimeCollectionEntryPatch{
		...
		NextAiringEpisode: &mediaapi.BaseAnime_NextAiringEpisode{Episode: 8, AiringAt: 1_700_000_200, TimeUntilAiring: 200},
	})
	...
	patchAnimeCollectionEntry(t, h.animeCollection, 146065, mediaapi.AnimeCollectionEntryPatch{
		Status:            new(mediaapi.MediaListStatusCurrent),
		NextAiringEpisode: &mediaapi.BaseAnime_NextAiringEpisode{Episode: 3, AiringAt: 1_700_000_050, TimeUntilAiring: 50},
	})
	...
	patchAnimeCollectionEntry(t, h.animeCollection, 21, mediaapi.AnimeCollectionEntryPatch{
		Status:            new(mediaapi.MediaListStatusDropped),
		NextAiringEpisode: &mediaapi.BaseAnime_NextAiringEpisode{Episode: 1100, AiringAt: 1_700_000_010, TimeUntilAiring: 10},
	})
