...
type Character struct {
	...
	// The url for the character page on the SIMKL website
...
type ListActivity struct {
	...
	// The url for the activity page on the SIMKL website
	SiteURL *string `json:"siteUrl,omitempty"`
...
type Media struct {
	...
	// The url for the media page on the SIMKL website
	SiteURL *string `json:"siteUrl,omitempty"`
...
type Review struct {
	...
	Private *bool `json:"private,omitempty"`
	// The url for the review page on the SIMKL website
	SiteURL *string `json:"siteUrl,omitempty"`
...
type Staff struct {
	...
	IsFavouriteBlocked bool `json:"isFavouriteBlocked"`
	// The url for the staff page on the SIMKL website
	SiteURL *string `json:"siteUrl,omitempty"`
...
type Studio struct {
	...
	Media *MediaConnection `json:"media,omitempty"`
	// The url for the studio page on the SIMKL website
	SiteURL *string `json:"siteUrl,omitempty"`
...
type Thread struct {
	...
	Likes []*User `json:"likes,omitempty"`
	// The url for the thread page on the SIMKL website
	SiteURL *string `json:"siteUrl,omitempty"`
...
type ThreadComment struct {
	...
	IsLiked *bool `json:"isLiked,omitempty"`
	// The url for the comment page on the SIMKL website
	SiteURL *string `json:"siteUrl,omitempty"`
...
type User struct {
	...
	// The url for the user page on the SIMKL website
	SiteURL *string `json:"siteUrl,omitempty"`
...
const (
	// An SIMKL administrator
	ModRoleAdmin ModRole = "ADMIN"
	// A head developer of SIMKL
