...
import (
	...
	"seall/internal/mediaplayers/mpvipc"
...
func (p *Playback) streamUsingMediaPlayer(windowTitle string, payload string, media *mediaapi.BaseAnime, aniDbEpisode string) goja.Value {
	promise, resolve, reject := p.vm.NewPromise()
