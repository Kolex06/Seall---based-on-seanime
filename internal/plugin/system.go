...
func (a *AppContextImpl) resolvePattern(pattern string) []string {
	...
	placeholders := []string{"$SEALL_ANIME_LIBRARY", "$HOME", "$CACHE", "$TEMP", "$CONFIG", "$DOWNLOAD", "$DESKTOP", "$DOCUMENT"}
