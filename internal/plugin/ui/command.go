...
func (c *CommandPaletteManager) jsNewCommandPalette(options NewCommandPaletteOptions) goja.Value {
	...
	_ = cmdObj.Set("input", c.componentManager.jsInput)
	_ = cmdObj.Set("radioGroup", c.componentManager.jsRadioGroup)
	_ = cmdObj.Set("switch", c.componentManager.jsSwitch)
	_ = cmdObj.Set("checkbox", c.componentManager.jsCheckbox)
	_ = cmdObj.Set("select", c.componentManager.jsSelect)
	_ = cmdObj.Set("css", c.componentManager.jsCSS)
	_ = cmdObj.Set("tooltip", c.componentManager.jsTooltip)
	_ = cmdObj.Set("modal", c.componentManager.jsModal)
	_ = cmdObj.Set("dropdownMenu", c.componentManager.jsDropdownMenu)
	_ = cmdObj.Set("dropdownMenuItem", c.componentManager.jsDropdownMenuItem)
	_ = cmdObj.Set("dropdownMenuSeparator", c.componentManager.jsDropdownMenuSeparator)
	_ = cmdObj.Set("dropdownMenuLabel", c.componentManager.jsDropdownMenuLabel)
	_ = cmdObj.Set("popover", c.componentManager.jsPopover)
	_ = cmdObj.Set("a", c.componentManager.jsA)
	_ = cmdObj.Set("p", c.componentManager.jsP)
	_ = cmdObj.Set("alert", c.componentManager.jsAlert)
	_ = cmdObj.Set("tabs", c.componentManager.jsTabs)
	_ = cmdObj.Set("tabsList", c.componentManager.jsTabsList)
	_ = cmdObj.Set("tabsTrigger", c.componentManager.jsTabsTrigger)
