...
const (
	...
	ClientMediaEntryEpisodeTabsRenderEvent             ClientEventType = "media:entry-episode-tabs:render"
	ClientMediaEntryEpisodeTabOpenEvent                ClientEventType = "media:entry-episode-tab:open"
	ClientMediaEntryEpisodeTabSelectEpisodeEvent       ClientEventType = "media:entry-episode-tab:select-episode"
	ClientMediaEntryEpisodeTabStateChangedEvent        ClientEventType = "media:entry-episode-tab:state-changed"
...
type ClientMediaEntryEpisodeTabsRenderEventPayload struct {
	MediaID int `json:"mediaId"`
}

type ClientMediaEntryEpisodeTabOpenEventPayload struct {
	MediaID int `json:"mediaId"`
}

type ClientMediaEntryEpisodeTabSelectEpisodeEventPayload struct {
	MediaID       int         `json:"mediaId"`
...
type ClientMediaEntryEpisodeTabStateChangedEventPayload struct {
...
const (
	...
	ServerMediaEntryEpisodeTabsUpdatedEvent            ServerEventType = "media:entry-episode-tabs:updated"
	ServerMediaEntryEpisodeTabEpisodeCollectionEvent   ServerEventType = "media:entry-episode-tab:episode-collection"
...
type ServerMediaEntryEpisodeTabsUpdatedEventPayload struct {
	Tabs interface{} `json:"tabs"`
}

type ServerMediaEntryEpisodeTabEpisodeCollectionEventPayload struct {
