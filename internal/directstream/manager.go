...
type (
	Manager struct {
		...
		animeCache      *result.Cache[int, *mediaapi.BaseAnime]
...
func (m *Manager) SetAnimeCollection(ac *mediaapi.AnimeCollection) {
...
func (m *Manager) getAnime(ctx context.Context, mediaId int) (*mediaapi.BaseAnime, error) {
