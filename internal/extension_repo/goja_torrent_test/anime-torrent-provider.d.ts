...
declare interface MediaTorrent {
    name: string
    date: string
    size: number
...
declare interface MediaTorrentProvider {
    ...
    getTorrentMagnetLink(torrent: MediaTorrent): Promise<string>

    // Returns the latest torrents.
    getLatest(): Promise<MediaTorrent[]>
