...
declare namespace $ui {
    ...
    interface Playback {
         ...
         */
        streamUsingMediaPlayer(windowTitle: string, streamUrl: string, anime: $app.MediaAPI_BaseMedia, aniDbEpisode: string): Promise<void>
        ...
        /**
         * Syncs the current progress with SIMKL.
         ...
         */
        getNextEpisode(): Promise<$app.Media_LocalFile | undefined>
    ...
    type AnimePageButtonAction = ActionObject<{ media: $app.MediaAPI_BaseMedia }> & { setTooltipText(text: string): void }

    type MangaPageButtonAction = ActionObject<{ media: $app.MediaAPI_BaseManga }> & { setTooltipText(text: string): void }
    ...
    interface Action {
         ...
         */
        newAnimePageDropdownItem(props: { label: string, style?: Record<string, string> }): ActionObject<{ media: $app.MediaAPI_BaseMedia }>
        ...
        newMediaCardContextMenuItem<F extends "anime" | "manga" | "both">(props: {
            ...
            media: F extends "anime" ? $app.MediaAPI_BaseMedia : F extends "manga" ? $app.MediaAPI_BaseManga : $app.MediaAPI_BaseMedia | $app.MediaAPI_BaseManga
        }> & {
         ...
         * @param props - Context menu item properties
         */
        newEpisodeCardContextMenuItem(props: { label: string, style?: Record<string, string> }): ActionObject<{ episode: $app.Media_Episode }>
        ...
        newEpisodeGridItemMenuItem(props: {
            ...
            episode: $app.Media_Episode | $app.Onlinestream_Episode,
            type: "library" | "torrentstream" | "debridstream" | "onlinestream" | "undownloaded" | "medialinks" | "mediastream"
        }>
    }
    ...
    interface Anime {
        ...
        registerEntryEpisodeTab(options: {
            ...
            onEpisodeCollection?: (event: {
                mediaId: number
                episodeCollection: $app.Media_EpisodeCollection
            }) => $app.Media_EpisodeCollection | undefined | Promise<$app.Media_EpisodeCollection | undefined>
            onSelectEpisode?: (event: {
                mediaId: number
                episodeNumber: number
                aniDbEpisode?: string
                episode?: $app.Media_Episode
            }) => void | Promise<void>
        }): {
            name: string
            icon?: string
         ...
         */
        getAnimeEntry(mediaId: number): Promise<$app.Media_Entry>

        /**
         * Get raw anime metadata from metadata provider
         * @param from - "simkl" | "mal" | "kitsu" | "anidb"
         * @param mediaId - The ID
         */
        getAnimeMetadata(from: "simkl" | "mal" | "kitsu" | "anidb", mediaId: number): Promise<$app.Metadata_AnimeMetadata | undefined>

        /**
         * Get download info for an anime entry.
         * @param mediaId - The ID of the anime
         */
        getEntryDownloadInfo(mediaId: number): Promise<$app.Media_EntryDownloadInfo>

        /**
         * Get the episode collection for an anime.
         * @param mediaId - The ID of the anime
         */
        getEpisodeCollection(mediaId: number): Promise<$app.Media_EpisodeCollection>

        /**
         * Clears episode metadata cache.
         * Note: To clear the anime entry cache, use $simkl.clearCache() (requires 'simkl' permission).
         */
    ...
    interface TorrentstreamMediaTorrentFile {
        index: number
        path: string
        name: string
    }
    ...
    interface TorrentstreamBatchEpisodeFiles {
        ...
        files: TorrentstreamMediaTorrentFile[]
    }
    ...
    interface TorrentstreamStartStreamOptions {
        ...
        aniDbEpisode: string
        autoSelect?: boolean
        torrent?: $app.HibikeTorrent_MediaTorrent
        fileIndex?: number
        userAgent?: string
        clientId?: string
    ...
    interface AutoSelect {
         ...
         */
        search(media: $app.MediaAPI_BaseMedia, episodeNumber: number): Promise<$app.HibikeTorrent_MediaTorrent[]>
    ...
    interface Scanner {
         ...
         */
        scan(options?: ScannerScanOptions): Promise<$app.Media_LocalFile[]>
    }
    ...
    interface FillerManager {
         ...
         */
        hydrateFillerData(e: $app.Media_Entry): void
    ...
    interface Debrid {
        ...
        /**
         * Gets queued local debrid downloads tracked in Seall's database.
         */
...
declare namespace $simkl {
    ...
    function updateEntry(
        mediaId: number,
        status: $app.MediaAPI_MediaListStatus | undefined,
        scoreRaw: number | undefined,
        progress: number | undefined,
        startedAt: $app.MediaAPI_FuzzyDateInput | undefined,
        completedAt: $app.MediaAPI_FuzzyDateInput | undefined,
    ): void
     ...
     */
    function GetMediaCollection(bypassCache: boolean): $app.MediaAPI_MediaCollection

    /**
     * Same as [$simkl.GetMediaCollection] but includes lists with no status (custom lists).
     */
    function GetRawMediaCollection(bypassCache: boolean): $app.MediaAPI_MediaCollection

    /**
     * Get the user's manga collection.
     * This collection does not include lists with no status (custom lists).
     */
    function getMangaCollection(bypassCache: boolean): $app.MediaAPI_MangaCollection

    /**
     * Same as [$simkl.getMangaCollection] but includes lists with no status (custom lists).
     */
    function getRawMangaCollection(bypassCache: boolean): $app.MediaAPI_MangaCollection

    /**
     * Get anime by ID
     */
    function getAnime(id: number): $app.MediaAPI_BaseMedia

    /**
     * Get manga by ID
     */
    function getManga(id: number): $app.MediaAPI_BaseManga

    /**
     * Get detailed anime info by ID
     */
    function getAnimeDetails(id: number): $app.MediaAPI_MediaDetailsById_Media

    /**
     * Get detailed manga info by ID
     */
    function getMangaDetails(id: number): $app.MediaAPI_MangaDetailsById_Media

    /**
     * Get anime collection with relations
     */
    function GetMediaCollectionWithRelations(): $app.MediaAPI_MediaCollectionWithRelations
     ...
     * Get studio details
     */
    function getStudioDetails(studioId: number): $app.MediaAPI_StudioDetails
    ...
    function listAnime(
        ...
        sort: $app.MediaAPI_MediaSort[] | undefined,
        status: $app.MediaAPI_MediaStatus[] | undefined,
        genres: string[] | undefined,
        averageScoreGreater: number | undefined,
        season: $app.MediaAPI_MediaSeason | undefined,
        seasonYear: number | undefined,
        format: $app.MediaAPI_MediaFormat | undefined,
        isAdult: boolean | undefined,
    ): $app.MediaAPI_ListMedia
...
declare namespace $database {
    ...
    namespace localFiles {
         ...
         */
        function getAll(): $app.Media_LocalFile[]
         ...
         * @returns The local files
         */
        function findBy(filterFn: (file: $app.Media_LocalFile) => boolean): $app.Media_LocalFile[]
         ...
         */
        function save(files: $app.Media_LocalFile[]): $app.Media_LocalFile[]

        /**
         * Inserts the local files as a new entry
         * @param files - The local files to insert
         */
        function insert(files: $app.Media_LocalFile[]): $app.Media_LocalFile[]
    }
    ...
    namespace simkl {
         ...
         * Get the Simkl token
         *
         * Permissions needed: simkl-token
         *
         * @returns The Simkl token
         */
        function getToken(): string

        /**
         * Get the Simkl username
         */
    ...
    namespace autoDownloaderRules {
         ...
         */
        function getAll(): $app.Media_AutoDownloaderRule[]
         ...
         */
        function get(id: number): $app.Media_AutoDownloaderRule | undefined
         ...
         */
        function getByMediaId(mediaId: number): $app.Media_AutoDownloaderRule[]

        /**
         * Inserts an auto downloader rule
         * @param rule - The auto downloader rule to insert
         */
        function insert(rule: Omit<$app.Media_AutoDownloaderRule, "dbId">): void
         ...
         */
        function update(id: number, rule: Omit<$app.Media_AutoDownloaderRule, "dbId">): void
    ...
    namespace autoDownloaderProfiles {
         ...
         */
        function getAll(): $app.Media_AutoDownloaderProfile[]
         ...
         */
        function get(id: number): $app.Media_AutoDownloaderProfile | undefined

        /**
         * Inserts an auto downloader profile
         * @param profile - The auto downloader profile to insert
         */
        function insert(profile: Omit<$app.Media_AutoDownloaderProfile, "dbId">): void
         ...
         */
        function update(id: number, profile: Omit<$app.Media_AutoDownloaderProfile, "dbId">): void
...
declare namespace $ui {
    ...
    interface VideoPlaylistState {
        type: PlaybackType
        episodes: $app.Media_Episode[]
        previousEpisode?: $app.Media_Episode
        nextEpisode?: $app.Media_Episode
        currentEpisode: $app.Media_Episode
        animeEntry?: $app.Media_Entry
    }
    ...
    interface VideoCore {
         ...
         */
        getCurrentMedia(): $app.MediaAPI_BaseMedia | undefined
         ...
         */
        playStream(streamUrl: string, anidbEpisode: string, media: $app.MediaAPI_BaseMedia): Promise<void>
