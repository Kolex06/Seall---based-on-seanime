...
const (
	...
	// ManageLists allows managing SIMKL/Custom source/Local lists.
	//	- Adding/updating/removing entries
	ManageLists FeatureKey = "ManageLists"
	// RefreshMetadata allows refreshing anime/manga metadata from Simkl and custom sources.
...
func NewFeatureManager(logger *zerolog.Logger, flags SeallFlags) *FeatureManager {
	ret := &FeatureManager{
