...
function init() {
	$ui.register((ctx) => {
		...
		const seallDefaultStyles: $cssm.Storage = [
    {
        "name":  "Clean Sidebar - fits seanime good",
        "author":  "Kolex06",
        "uuid":  "bbc478d0-6ff8-413a-999b-cd987a38b338",
        "enabled":  true,
        "style":  {
                      "desktop":  "/* ============================= */\n/* CLEAN SIDEBAR – Optimized     */\n/* ============================= */\n\n/* Sidebar container – transparent, no panel */\n.sidebar,\n.nav-drawer,\naside[role=\"complementary\"],\naside[class*=\"side\"],\nnav[aria-label*=\"sidebar\"],\nnav[aria-label*=\"Side\"],\nnav[aria-label*=\"Navigation\"] {\n  background: transparent !important;\n  border-right: 0 !important;\n  box-shadow: none !important;\n  backdrop-filter: none !important;\n  -webkit-backdrop-filter: none !important;\n}\n\n/* Sidebar items – dark pill with soft teal edge */\n.sidebar a,\n.sidebar button,\n.nav-drawer a,\n.nav-drawer button,\naside a,\naside button {\n  display: flex;\n  align-items: center;\n  gap: 0.55rem;\n  padding: 0.55rem 0.9rem;\n  margin: 2px 4px;\n  border-radius: 999px !important;\n\n  background: rgba(15, 23, 42, 0.75) !important;\n  border: 1px solid rgba(148, 163, 184, 0.28) !important;\n\n  backdrop-filter: blur(10px) !important;\n  -webkit-backdrop-filter: blur(10px) !important;\n\n  text-decoration: none;\n  transition:\n    background-color 140ms ease,\n    border-color 140ms ease,\n    transform 140ms ease;\n}\n\n/* Hover – tiny move, slight teal */\n.sidebar a:hover,\n.sidebar button:hover,\n.nav-drawer a:hover,\n.nav-drawer button:hover,\naside a:hover,\naside button:hover {\n  background: rgba(15, 23, 42, 0.95) !important;\n  border-color: rgba(45, 212, 191, 0.6) !important;\n  transform: translateX(2px);\n}\n\n/* Active / current item – thin teal outline */\n.sidebar .active,\n.nav-drawer .active,\naside .active,\n.sidebar a[aria-current],\n.sidebar button[aria-current],\nnav[aria-label*=\"sidebar\"] a[aria-current],\nnav[aria-label*=\"sidebar\"] button[aria-current] {\n  background: rgba(15, 23, 42, 0.98) !important;\n  border-color: rgba(45, 212, 191, 0.9) !important;\n}",
                      "mobile":  ""
                  },
        "link":  "https://discord.com/channels/1224767201551192224/1446383540823658628"
    },
    {
        "name":  "Alternative compact episode card (6 row per column)",
        "author":  "folfoẚ",
        "uuid":  "3a8b6d93-e45f-415d-98d6-64c24b20bad6",
        "enabled":  true,
        "style":  {
                      "desktop":  "/*Seanime compact grid card (6) */\n[data-episode-list-grid] {\n\tgrid-template-columns: repeat(6, minmax(0, 1fr));\n\tdisplay: grid !important;\n}\n\n[data-episode-grid-item-image-container] {\n\tborder-radius: 4px;\n\twidth: 100%;\n}\n\n[data-episode-grid-item-image-overlay] {\n\tbox-shadow: inset 0 0 12px rgba(0, 0, 0, 0.5);\n}\n\n[data-episode-grid-item-content] {\n\tdisplay: grid;\n\tposition: absolute;\n\tbottom: 2px;\n\tright: 4px;\n\ttext-shadow: 0px 0px 3px rgb(0,0,0), 0px 0px 1px rgb(255,255,255);\n}\n\n[data-episode-grid-item-episode-title] {\n\tfont-size: 0.9rem !important;\n\tbottom: 2px;\n\tright: 4px;\n\ttext-align: right;\n\ttext-wrap: balance;\n}\n\n[data-episode-grid-item-title] {\n\tfont-size: 0.9rem;\n\tbottom: 2px;\n\tright: 2px;\n\ttext-align: right;\n}\n\n[data-episode-grid-item-episode-description],\n[data-episode-grid-item-filename] {\n\tdisplay: none !important;\n}",
                      "mobile":  ""
                  },
        "link":  "https://discord.com/channels/1224767201551192224/1410580738176319508"
    },
    {
        "name":  "Make best releases stand out",
        "author":  "folfoẚ",
        "uuid":  "22c4e6eb-5a6c-431e-aac5-cba513c27335",
        "enabled":  true,
        "style":  {
                      "desktop":  "/* Make Best Releases Stand Out */\n[data-is-best-release=\"true\"] {\n\tbackground-color: rgba(14,50,80,0.2) !important;\n\tbox-shadow: 0 0 3px 1px #247fcc;\n}",
                      "mobile":  ""
                  },
        "link":  "https://discord.com/channels/1224767201551192224/1408012470349463712"
    }
];
		const icons = {
			html: {
		...
		const manager = {
			...
			seedSeallDefaultStyles() {
				const seedKey = `${this.id}:seall-defaults-seeded`;
				if ($storage.get(seedKey)) return;

				const current = this.storage;
				const missing = seallDefaultStyles.filter((style) => !current.some((existing) => existing.uuid.toString() === style.uuid.toString()));
				if (missing.length) {
					$storage.set(this.id, [...current, ...missing]);
					this.updateCSS();
				}
			...
			async fetchMarketplace() {
				try {
					...
					const community: $cssm.Storage = res.json();
					const data = [
						...seallDefaultStyles,
						...community.filter((style) => !seallDefaultStyles.some((preset) => preset.uuid.toString() === style.uuid.toString())),
					];
					$store.set(`marketplace:${this.id}`, data);
					return data;
				} catch (error) {
					$store.set(`marketplace:${this.id}`, seallDefaultStyles);
					return seallDefaultStyles;
				}
			},
		...
		manager.seedSeallDefaultStyles();
