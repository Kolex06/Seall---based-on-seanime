...
type Settings struct {
	BaseModel
	// Flag to determine if there are local changes that need to be synced with SIMKL.
...
// LocalCollection is an simkl collection that is stored locally for offline use.
// It is meant to be kept in sync with the real SIMKL collection when online.
...
//type LocalMangaListEntry simkl.MangaListEntry
//
...
//type LocalAnimeListEntry simkl.AnimeListEntry
//
