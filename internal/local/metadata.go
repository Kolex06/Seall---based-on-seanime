...
func (mp *OfflineMetadataProvider) GetAnimeMetadata(platform metadata.Platform, mId int) (*metadata.AnimeMetadata, error) {
	if platform != metadata.MediaPlatform {
...
func (mp *OfflineMetadataProvider) GetAnimeMetadataWrapper(anime *mediaapi.BaseAnime, metadata *metadata.AnimeMetadata) metadata_provider.AnimeMetadataWrapper {
