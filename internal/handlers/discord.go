...
//	@route /api/v1/discord/presence/reading [POST]
//	@returns bool
...
//	@route /api/v1/discord/presence/legacy-media [POST]
//	@returns bool
...
//	@route /api/v1/discord/presence/media [POST]
//	@returns bool
...
//	@route /api/v1/discord/presence/media-update [POST]
//	@returns bool
