...
import (
	...
	chapter_downloader "seall/internal/manga/downloader"
	"time"
...
//	@route /api/v1/reading/download-chapters [POST]
//	@returns bool
...
//	@route /api/v1/reading/download-data [POST]
...
//	@route /api/v1/reading/download-queue [GET]
...
//	@route /api/v1/reading/download-queue/start [POST]
//	@returns bool
...
//	@route /api/v1/reading/download-queue/stop [POST]
//	@returns bool
...
//	@route /api/v1/reading/download-queue [DELETE]
//	@returns bool
...
//	@desc This will also send a websocket event telling the client to refetch the download queue.
//	@route /api/v1/reading/download-queue/reset-errored [POST]
//	@returns bool
...
//	@route /api/v1/reading/download-chapter [DELETE]
//	@returns bool
...
//	@desc It returns a list of manga.DownloadListItem where the media data might be nil if it's not in the SIMKL collection.
//	@route /api/v1/reading/downloads [GET]
