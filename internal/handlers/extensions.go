...
//	@route /api/v1/extensions/list/reading-provider [GET]
...
// HandleListMediaTorrentProviderExtensions
//
//	@summary returns the installed torrent providers.
//	@route /api/v1/extensions/list/media-torrent-provider [GET]
//	@returns []extension_repo.MediaTorrentProviderExtensionItem
func (h *Handler) HandleListMediaTorrentProviderExtensions(c echo.Context) error {
	extensions := h.App.ExtensionRepository.ListMediaTorrentProviderExtensions()
	return h.RespondWithData(c, extensions)
}

// HandleListMediaEntryEpisodeTabExtensions
//
//	@summary returns the installed plugins that registered an anime entry episode tab.
//	@route /api/v1/extensions/list/media-entry-episode-tabs [GET]
//	@returns []extension_repo.PluginEpisodeTabExtensionItem
func (h *Handler) HandleListMediaEntryEpisodeTabExtensions(c echo.Context) error {
	extensions := h.App.ExtensionRepository.ListMediaEntryEpisodeTabExtensions()
	return h.RespondWithData(c, extensions)
}
