...
func (h *Handler) FeaturesMiddleware(next echo.HandlerFunc) echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		var pathFeatureConfigs = []pathFeatureConfig{
			...
			// lists
			{"/api/v1/simkl/list-entry", h.App.FeatureManager.IsDisabled(core.ManageLists), UpdateMethods, Empty},
			{"/api/v1/library/media-entry/update-progress", h.App.FeatureManager.IsDisabled(core.ManageLists), UpdateMethods, Empty},
			{"/api/v1/library/media-entry/update-repeat", h.App.FeatureManager.IsDisabled(core.ManageLists), UpdateMethods, Empty},
			{"/api/v1/reading/update-progress", h.App.FeatureManager.IsDisabled(core.ManageLists), UpdateMethods, Empty},
			// refresh metadata
			{"/api/v1/simkl/cache-layer/status", h.App.FeatureManager.IsDisabled(core.RefreshMetadata), UpdateMethods, Empty},
			{"/api/v1/library/scan", h.App.FeatureManager.IsDisabled(core.RefreshMetadata), UpdateMethods, Empty},
			{"/api/v1/reading/refetch-chapter-containers", h.App.FeatureManager.IsDisabled(core.RefreshMetadata), UpdateMethods, Empty},
			// playlists
			...
			{"/api/v1/library/media-entry/open-in-explorer", h.App.FeatureManager.IsDisabled(core.OpenInExplorer), UpdateMethods, Empty},
			// debrid
			...
			// reading
			{"/api/v1/reading", h.App.FeatureManager.IsDisabled(core.ManageMangaSource), UpdateMethods, []string{"/api/v1/reading/pages", "/api/v1/reading/chapters"}},
			{"/api/v1/reading", h.App.FeatureManager.IsDisabled(core.Reading), UpdateMethods, Empty},
			// reading downloads
			{"/api/v1/reading/download", h.App.FeatureManager.IsDisabled(core.ManageMangaDownloads), UpdateMethods, Empty},
			// local anime library
			...
			{"/api/v1/library", h.App.FeatureManager.IsDisabled(core.ManageLocalAnimeLibrary), UpdateMethods, []string{"/api/v1/library/media-entry/update-progress", "/api/v1/library/media-entry/update-repeat"}},
		...
		if h.App.FeatureManager.IsDisabled(core.PushRequests) {
			pathPrefixes = append(pathPrefixes, "/api/v1/simkl/list-media", "/api/v1/simkl/list-recent-airing-media", "/api/v1/reading/simkl/list", "/api/v1/announcements")
