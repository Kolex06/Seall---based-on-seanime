...
const (
	clientIdHeaderName      = "X-Seall-Client-Id"
	clientIdProofHeaderName = "X-Seall-Client-Id-Proof"
	clientIdCookieName      = "Seall-Client-Id"
	clientIdQueryParam      = "id"
	clientIdProofQueryParam = "proof"
	clientPlatformHeader    = "X-Seall-Client-Platform"
