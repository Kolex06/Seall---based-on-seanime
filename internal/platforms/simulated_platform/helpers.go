...
func (sp *SimulatedPlatform) GetMediaCollectionWrapper() *CollectionWrapper {
...
func (cw *CollectionWrapper) AddEntry(mediaId int, status mediaapi.MediaListStatus) error {
	if cw.isAnime {
...
func (cw *CollectionWrapper) UpdateEntry(mediaId int, status *mediaapi.MediaListStatus, scoreRaw *int, progress *int, startedAt *mediaapi.FuzzyDateInput, completedAt *mediaapi.FuzzyDateInput) error {
	if cw.isAnime {
...
func (cw *CollectionWrapper) UpdateMediaData(mediaId int, mediaData interface{}) error {
	if cw.isAnime {
		if baseAnime, ok := mediaData.(*mediaapi.BaseAnime); ok {
			return cw.updateAnimeMediaData(mediaId, baseAnime)
		}
		return errors.New("invalid anime data type")
	}

	if baseManga, ok := mediaData.(*mediaapi.BaseManga); ok {
...
func (cw *CollectionWrapper) addAnimeEntry(mediaId int, status mediaapi.MediaListStatus) error {
	...
	// Create new entry
	newEntry := &mediaapi.AnimeCollection_MediaListCollection_Lists_Entries{
		...
		Repeat:      new(0),
		Private:     new(false),
		StartedAt:   &mediaapi.AnimeCollection_MediaListCollection_Lists_Entries_StartedAt{},
		CompletedAt: &mediaapi.AnimeCollection_MediaListCollection_Lists_Entries_CompletedAt{},
	}
...
func (cw *CollectionWrapper) updateAnimeEntry(mediaId int, status *mediaapi.MediaListStatus, scoreRaw *int, progress *int, startedAt *mediaapi.FuzzyDateInput, completedAt *mediaapi.FuzzyDateInput) error {
	collection, err := cw.platform.getOrCreateAnimeCollection()
	if err != nil {
		return err
	}

	var foundEntry *mediaapi.AnimeCollection_MediaListCollection_Lists_Entries
	var sourceList *mediaapi.AnimeCollection_MediaListCollection_Lists
	var entryIndex int
	...
	if startedAt != nil {
		foundEntry.StartedAt = &mediaapi.AnimeCollection_MediaListCollection_Lists_Entries_StartedAt{
			Year:  startedAt.Year,
	...
	if completedAt != nil {
		foundEntry.CompletedAt = &mediaapi.AnimeCollection_MediaListCollection_Lists_Entries_CompletedAt{
...
func (cw *CollectionWrapper) findAnimeEntry(mediaId int, isEntryId ...bool) (*mediaapi.AnimeCollection_MediaListCollection_Lists_Entries, error) {
	collection, err := cw.platform.getOrCreateAnimeCollection()
	if err != nil {
		return nil, err
	}
...
func (cw *CollectionWrapper) updateAnimeMediaData(mediaId int, mediaData *mediaapi.BaseAnime) error {
	collection, err := cw.platform.getOrCreateAnimeCollection()
	if err != nil {
		return err
	}
...
func (cw *CollectionWrapper) addMangaEntry(mediaId int, status mediaapi.MediaListStatus) error {
	...
	// Create new entry
	newEntry := &mediaapi.MangaCollection_MediaListCollection_Lists_Entries{
		...
		Repeat:      new(0),
		Private:     new(false),
		StartedAt:   &mediaapi.MangaCollection_MediaListCollection_Lists_Entries_StartedAt{},
		CompletedAt: &mediaapi.MangaCollection_MediaListCollection_Lists_Entries_CompletedAt{},
	}
...
func (cw *CollectionWrapper) updateMangaEntry(mediaId int, status *mediaapi.MediaListStatus, scoreRaw *int, progress *int, startedAt *mediaapi.FuzzyDateInput, completedAt *mediaapi.FuzzyDateInput) error {
	collection, err := cw.platform.getOrCreateMangaCollection()
	if err != nil {
		return err
	}

	var foundEntry *mediaapi.MangaCollection_MediaListCollection_Lists_Entries
	var sourceList *mediaapi.MangaCollection_MediaListCollection_Lists
	var entryIndex int
	...
	if startedAt != nil {
		foundEntry.StartedAt = &mediaapi.MangaCollection_MediaListCollection_Lists_Entries_StartedAt{
			Year:  startedAt.Year,
			Month: startedAt.Month,
			Day:   startedAt.Day,
		}
	...
	if completedAt != nil {
		foundEntry.CompletedAt = &mediaapi.MangaCollection_MediaListCollection_Lists_Entries_CompletedAt{
			Year:  completedAt.Year,
			Month: completedAt.Month,
			Day:   completedAt.Day,
		}
...
func (cw *CollectionWrapper) findMangaEntry(mediaId int, isEntryId ...bool) (*mediaapi.MangaCollection_MediaListCollection_Lists_Entries, error) {
	collection, err := cw.platform.getOrCreateMangaCollection()
	if err != nil {
		return nil, err
	}
...
func (cw *CollectionWrapper) updateMangaMediaData(mediaId int, mediaData *mediaapi.BaseManga) error {
	collection, err := cw.platform.getOrCreateMangaCollection()
	if err != nil {
		return err
	}
