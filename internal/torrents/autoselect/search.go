...
func (s *AutoSelect) Search(ctx context.Context, media *mediaapi.BaseAnime, episodeNumber int, profile *anime.AutoSelectProfile) ([]*hibiketorrent.MediaTorrent, error) {
	if ctx == nil {
...
func (s *AutoSelect) search(ctx context.Context, media *mediaapi.CompleteAnime, episodeNumber int, profile *anime.AutoSelectProfile) ([]*hibiketorrent.MediaTorrent, error) {
...
func (s *AutoSelect) searchFromProviders(
...
) ([]*hibiketorrent.MediaTorrent, error) {
	...
	var allTorrents []*hibiketorrent.MediaTorrent
	var lastErr error
...
func (s *AutoSelect) shouldSearchBatch(media *mediaapi.CompleteAnime) bool {
...
func (s *AutoSelect) validateBatchResults(torrents []*hibiketorrent.MediaTorrent) bool {
	nbFound := len(torrents)
	seedersArr := lo.Map(torrents, func(t *hibiketorrent.MediaTorrent, _ int) int {
		return t.Seeders
	})
