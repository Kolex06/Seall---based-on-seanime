...
func (r *Repository) reloadExtensions() {
	...
	go func() {
		...
		extension.RangeExtensions(r.extensionBankRef.Get(), func(provider string, value extension.MediaTorrentProviderExtension) bool {
...
func (r *Repository) GetDefaultAnimeProviderExtension() (extension.MediaTorrentProviderExtension, bool) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *Repository) GetAutoSelectProviderExtension() (extension.MediaTorrentProviderExtension, bool) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *Repository) GetAnimeProviderExtension(id string) (extension.MediaTorrentProviderExtension, bool) {
	return extension.GetExtension[extension.MediaTorrentProviderExtension](r.extensionBankRef.Get(), id)
}

// GetAnimeProviderExtensionOrFirst returns the extension with the given ID, or the first one if the extension is not found
func (r *Repository) GetAnimeProviderExtensionOrFirst(id string) (extension.MediaTorrentProviderExtension, bool) {
	ext, found := extension.GetExtension[extension.MediaTorrentProviderExtension](r.extensionBankRef.Get(), id)
	if !found {
		ids := r.GetAllAnimeProviderExtensionIds()
		...
		ext, _ = extension.GetExtension[extension.MediaTorrentProviderExtension](r.extensionBankRef.Get(), id)
	}
	return ext, true
}

// GetAnimeProviderExtensionOrDefault returns the extension with the given ID, or the default one
func (r *Repository) GetAnimeProviderExtensionOrDefault(id string) (extension.MediaTorrentProviderExtension, bool) {
	ext, found := extension.GetExtension[extension.MediaTorrentProviderExtension](r.extensionBankRef.Get(), id)
	if !found {
...
func (r *Repository) GetAllAnimeProviderExtensionIds() []string {
	ids := make([]string, 0)
	extension.RangeExtensions[extension.MediaTorrentProviderExtension](r.extensionBankRef.Get(), func(id string, ext extension.MediaTorrentProviderExtension) bool {
		ids = append(ids, id)
		return true
	})
	return ids
...
func (r *Repository) GetAnimeProviderExtensionsBy(pred func(ext extension.MediaTorrentProviderExtension) bool) []extension.MediaTorrentProviderExtension {
	exts := make([]extension.MediaTorrentProviderExtension, 0)
	extension.RangeExtensions[extension.MediaTorrentProviderExtension](r.extensionBankRef.Get(), func(id string, ext extension.MediaTorrentProviderExtension) bool {
		if pred(ext) {
